...
//  const { data: boundaryList = {}, iswLoading } = Digit.Hooks.tl.useTradeLicenseMDMS(tenantId, "cochin/egov-location", "boundary-data");
 ...
 const [MotherDistrict, setMotherDistrict] = useState(formData?.AddressPermanentDetails?.MotherDistrict);
 const [MotherLBTypeName, setMotherLBTypeName] = useState(formData?.AddressPermanentDetails?.MotherLBTypeName);
 const [MotherLBName, setMotherLBName] = useState(formData?.AddressPermanentDetails?.MotherLBName);
 const [MotherTaluk, setMotherTaluk] = useState(formData?.AddressPermanentDetails?.MotherTaluk);
 const [MotherPostOffice, setMotherPostOffice] = useState(formData?.AddressPermanentDetails?.MotherPostOffice);
 const [MotherPincode, setMotherPincode] = useState(formData?.AddressPermanentDetails?.MotherPincode);
 const [MotherHouseNameEn, setMotherHouseNameEn] = useState(formData?.AddressPermanentDetails?.MotherHouseNameEn); 
 const [MotherHouseNameMl, setMotherHouseNameMl] = useState(formData?.AddressPermanentDetails?.MotherHouseNameMl); 
 const [MotherBuldingNo, setMotherBuldingNo] = useState(formData?.AddressPermanentDetails?.MotherBuldingNo);
 const [MotherDoorNo, setMotherDoorNo] = useState(formData?.AddressPermanentDetails?.MotherDoorNo);
 const [MotherMainPlaceEn, setMotherMainPlaceEn] = useState(formData?.AddressPermanentDetails?.MotherMainPlaceEn); 
 const [MotherMainPlaceMl, setMotherMainPlaceMl] = useState(formData?.AddressPermanentDetails?.MotherMainPlaceMl); 
 const [MotherLocalityNameEn, setMotherLocalityNameEn] = useState(formData?.AddressPermanentDetails?.MotherLocalityNameEn); 
 const [MotherLocalityNameMl, setMotherLocalityNameMl] = useState(formData?.AddressPermanentDetails?.MotherLocalityNameMl);
 const [MotherStreetNameEn, setMotherStreetNameEn] = useState(formData?.AddressPermanentDetails?.MotherStreetNameEn);
 const [MotherStreetNameMl, setMotherStreetNameMl] = useState(formData?.AddressPermanentDetails?.MotherStreetNameMl);  
 const [MotherVillage, setMotherVillage] = useState(formData?.AddressPermanentDetails?.MotherVillage);  
...
function setSelectMotherPincode(e) {
 ...
 onSelect(config.key, {
  ...
  MotherStreetNameMl, MotherVillage, MotherLBName, MotherDistrict, MotherTaluk, MotherPostOffice, MotherPincode,
