...
const BirthMotherAddress = ({ config, onSelect, userType, formData }) => {
    ...
    <div className="row">
        <div className="col-md-6" >
            ...
            <TextInput       
                ...
                onChange={setSelectTradeName}
                disable={isEdit}
                {...(validation = { pattern: "^[a-zA-Z-.`' ]*$", isRequired: true, type: "text", title: t("CS_COMMON_INVALID_COUNTRY") })}
            /> 
        </div>                  
    </div>       
...
export default BirthMotherAddress;
