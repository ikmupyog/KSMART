          ...
          <div className="col-md-8">
            <div className="row">
              <div className="col-md-12">
                ...
                <div className="col-md-6">{MarriageDetails?.marriageDOM ? MarriageDetails?.marriageDOM : "CR_NOT_RECORDED"}</div>
              </div>
            </div>
            <div className="row">
              <div className="col-md-12">
                ...
                <div className="col-md-6">{MarriageDetails?.marriagePlacetype ? MarriageDetails?.marriagePlacetype : ""}</div>
              </div>
            </div>
          </div>
          <div className="col-md-2">
