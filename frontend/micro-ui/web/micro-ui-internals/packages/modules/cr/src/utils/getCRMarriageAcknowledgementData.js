...
//   };
// };
const getMarriageDetails = (application, t) => {
  console.log({application});
  application.owners = application?.MarriageDetails?.filter((applicationNumber) => applicationNumber.active == true) || [];
  //if (application?.MarriageDetails?.applicationNumber == "TL_COMMON_TABLE_COL_APP_NO") {
...
const getCRMarriageAcknowledgementData = async (application, tenantInfo, t) => {
  ...
  return {
    ...
    details: [
      ...
      getMarriageDetails(application, t),
...
export default getCRMarriageAcknowledgementData;
