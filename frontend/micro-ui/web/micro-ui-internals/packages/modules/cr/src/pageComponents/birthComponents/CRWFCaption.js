...
import CRWFReason from "./CRWFReason";

const CRWFCaption = ({ data }) => {
  ...
  return (
    <div>
      ...
      {/* //TODO: please find a better way to display in checkpoints */}
      {data.comment && <CRWFReason otherComment={data?.otherComment} headComment={data?.comment}></CRWFReason>}
    </div>
  );
};

export default CRWFCaption;