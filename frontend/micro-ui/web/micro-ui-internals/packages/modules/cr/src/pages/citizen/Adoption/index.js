...
const CreateAdoption = ({ parentUrl, isEditBirth }) => {
  ...
  config.indexRoute = "adoption-child-details";
  ...
  const AdoptionAcknowledgement = Digit?.ComponentRegistryService?.getComponent("AdoptionAcknowledgement");
  return (
