...
const AddressPermanentOutsideKerala = ({ config, onSelect, userType, formData, permntOutsideKeralaDistrict, setpermntOutsideKeralaDistrict,
  ...
  value, setValue,isEditBirth = false, isEditAbandonedDeath = false,
        ...
        <div className="row">
          ...
          <div className="col-md-4">
            ...
            <TextInput
              ...
              disable={isDisableEdit} 
              placeholder={`${t("CS_COMMON_POST_OFFICE")}`}
              {...(validation = { pattern: "^[a-zA-Z-.`' ]*$", isRequired: false,isRequired: true, type: "text", title: t("CR_INVALID_CITY_VILLAGE_NAME_EN") })}
            />
          </div>
          {/* <div className="col-md-4">
            <CardLabel>
