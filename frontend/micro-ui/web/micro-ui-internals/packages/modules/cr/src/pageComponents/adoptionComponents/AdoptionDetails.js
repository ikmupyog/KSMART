...
const AdoptionDetails = ({ config, onSelect, userType, formData }) => {
  ...
  useEffect(() => {
    ...
    function setSelectAdoptionAgencyName(e) {
        ...
        setAdoptionAgencyName(e.target.value.replace(/^^[\u0D00-\u0D7F\u200D\u200C .&'@' 0-9]/ig,''));
    }  
}
    function setSelectAdoptionAgencyAddress  (e) {
        ...
        setAdoptionAgencyAddress(e.target.value.replace(/^^[\u0D00-\u0D7F\u200D\u200C .&'@' 0-9]/ig,''));
    }  
}
    function setSelectAdoptionContactName  (e) {
        ...
        setAdoptionContactName(e.target.value.replace(/^^[\u0D00-\u0D7F\u200D\u200C .&'@' 0-9]/ig,''));
    }  
}
    ...
    function selectRadioButtons(value) {
      ...
      function setSelectAdoptionIssuingAthority(e) {
        if (e.target.value.length === 51) {
          ...
          setAdoptionIssuingAthority(e.target.value.replace(/^^[\u0D00-\u0D7F\u200D\u200C .&'@' 0-9]/ig,''));
        }
      }
      ...
      function setSelectAdoptiveFirstNameEn(e) {
        if (e.target.value.length === 51) {
          ...
          setAdoptiveFirstNameEn(e.target.value.replace(/^^[\u0D00-\u0D7F\u200D\u200C .&'@' 0-9]/ig,''));
        }
      }
      function setSelectAdoptiveMiddleNameEn(e) {
        if (e.target.value.length === 51) {
          ...
          setAdoptiveMiddleNameEn(e.target.value.replace(/^^[\u0D00-\u0D7F\u200D\u200C .&'@' 0-9]/ig,''));
        }
      }
      function setSelectAdoptiveLastNameEn(e) {
        if (e.target.value.length === 51) {
          ...
          setAdoptiveLastNameEn(e.target.value.replace(/^^[\u0D00-\u0D7F\u200D\u200C .&'@' 0-9]/ig,''));
        }
      }
      function setSelectAdoptiveFirstNameMl(e) {
        if (e.target.value.length === 51) {
          ...
          setAdoptiveFirstNameMl(e.target.value.replace(/^[a-zA-Z-.`'0-9 ]/ig,''));
        }
      }
      function setSelectAdoptiveMiddleNameMl(e) {
        if (e.target.value.length === 51) {
          ...
          setAdoptiveMiddleNameMl(e.target.value.replace(/^[a-zA-Z-.`'0-9 ]/ig,''));
        }
      }
      function setSelectAdoptiveLastNameMl(e) {
        if (e.target.value.length === 51) {
          ...
          setAdoptiveLastNameMl(e.target.value.replace(/^[a-zA-Z-.`'0-9 ]/ig,''));
        }
      }
            ...
            <div className="radios">
              <div className="radiobuttons">
                <LabelFieldPair style={{ display: "flex" }}>
                  <RadioButtons t={t} optionsKey="i18nKey" options={menus} selectedOption={selectedValueRadio} onSelect={selectRadioButtons} style={{ marginTop: "-8px", paddingLeft: "5px", height: "25px", display: "flex" }} />
                </LabelFieldPair>
              </div>
            </div>
          </div>
