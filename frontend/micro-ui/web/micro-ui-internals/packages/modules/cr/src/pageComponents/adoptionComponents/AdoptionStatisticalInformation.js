...
const StatisticalInformation = ({ config, onSelect, userType, formData }) => {
    ...
    const [BirthPlaceDescription, setBirthPlaceDescription] = useState(formData?.StatisticalInfoDetails?.BirthPlaceDescription);
    ...
    const goNext = () => {
        ...
        onSelect(config.key, { BirthWeight, BirthHeight, Religion, PregnancyDuration, MedicalAttension, MedicalAttensionSub, DeliveryMethod, DeliveryMethodSub,BirthPlaceDescription });
    }
    return (
        <React.Fragment>
