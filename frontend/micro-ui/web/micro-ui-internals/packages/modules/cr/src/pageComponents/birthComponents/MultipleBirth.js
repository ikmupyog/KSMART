  ...
  return (
    <React.Fragment>
      ...
      <FormStep t={t} config={config} onSelect={goNext} onSkip={onSkip} isDisabled={!ChildDOB || !Gender}>
        ...
        <div className="row">
          <div className="col-md-12" ><h1 className="headingh1" ><span className="headingline">{`${t("CR_MULTIPLE_BIRTH")}`}</span> </h1>
          </div>
        </div>
        <div className="row">
        ...
        <div className="row">
          <div className="col-md-12" ><h1 className="headingh1" ><span className="headingline">{`${t("CR_NAME_OF_CHILD")}`}</span> </h1>
          </div>
        </div>
        <div className="row">
