...
const BrideAddressPermanentOutsideKerala = ({ config, onSelect, userType, formData, permntOutsideKeralaDistrict, setpermntOutsideKeralaDistrict,
  ...
  permntOutsideKeralaPostOfficeEn, setpermntoutsideKeralaPostOfficeEn, permntOutsideKeralaPostOfficeMl, setpermntoutsideKeralaPostOfficeMl, setpermntInKeralaAdrDistrict, setpermntInKeralaAdrLBName,
...
//isEditBirth ? isEditBirth : isEditDeath ? false :
  ...
  if (isEditBirth) {
    ...
    if (formData?.BrideAddressDetails?.permntOutsideKeralaDistrict != null) {
      if (cmbDistrict.length > 0 && (permntOutsideKeralaDistrict === undefined || permntOutsideKeralaDistrict === "")) {
        setpermntOutsideKeralaDistrict(cmbDistrict.filter(cmbDistrict => cmbDistrict.code === formData?.BrideAddressDetails?.permntOutsideKeralaDistrict)[0]);
      }
    }
    ...
    if (formData?.BrideAddressDetails?.permntOutsideKeralaVillage != null) {
      if (cmbUrbanRural.length > 0 && (permntOutsideKeralaVillage === undefined || permntOutsideKeralaVillage === "")) {
        setpermntOutsideKeralaVillage(cmbUrbanRural.filter(cmbUrbanRural => cmbUrbanRural.code === formData?.BrideAddressDetails?.permntOutsideKeralaVillage)[0]);
      }
    }
