    ...
    return (
      <React.Fragment>
        ...
        <FormStep
          ...
          onSelect={goNext}
          onSkip={onSkip}
          isDisabled={!ChildDOB || !tripStartTime || !Gender || !ChildFirstNameEn || !ChildLastNameEn || !ChildFirstNameMl || !ChildLastNameMl}
        >
          <div className="row">
          ...
          <div className="row">
            <div className="col-md-12">
              <h1 className="headingh1">
                <span style={{ background: "#fff", padding: "0 10px" }}>{`${t("OTHER_DETAILS")}`}</span>{" "}
              </h1>
            </div>
          </div>
          <div className="row">
              ...
              <div className="row">
                ...
                <div className="col-md-6">
                  ...
                  <TextInput
                    ...
                    value={ChildArrivalDate}
                    onChange={setSelectArrivalDate}
                    disable={isEdit}
                    placeholder={`${t("CR_DATE_OF_ARRIVAL")}`}
                    {...(validation = { pattern: "^[a-zA-Z-.`' ]*$", isRequired: false, type: "text", title: t("CR_INVALID_DATE_OF_ARRIVAL") })}
                  />
                </div>
              </div>
            </div>
    ...
    <React.Fragment>
      ...
      <FormStep t={t} config={config} onSelect={goNext} onSkip={onSkip} isDisabled={!ChildDOB}>
        ...
        <div className="row">
          ...
          <div className="col-md-4">
            ...
            <TextInput
              ...
              onChange={setSelectChildAadharNo}
              disable={isEdit}
              {...(validation = { pattern: "^([0-9]){12}$", isRequired: true, type: "text", title: t("TL_INVALID_AADHAR_NO") })}
            />
          </div>
        </div>
        <div className="row">
        ...
        <div className="row">
          <div className="col-md-12">
            <h1 className="headingh1">
              <span style={{ background: "#fff", padding: "0 10px" }}>{`${t("Other Details")}`}</span>{" "}
            </h1>
          </div>
        </div>
        <div className="row">
        ...
        <div className="row">
          ...
          <div className="col-md-6">
            {" "}
            <CardLabel>{`${t("Date of Arrival")}`}</CardLabel>
            <TextInput
              t={t}
              isMandatory={false}
              type={"text"}
