    ...
    <React.Fragment>
      ...
      <Card>
          ...
          content={<StatusTable >
            ...
            <div className="row">
              <div className="col-md-10">
                ...
                <div className="col-md-5">
                  <CardText style={{ fontSize: "15px", Colour: "black" }}>{t(InformationDeath?.Age) + "  " + t(InformationDeath?.AgeUnit.name)}
                  </CardText>
                </div>
                <div className="col-md-5">
        ...
        <Accordion expanded={false} title={t("CR_DEATH_PLACE_DETAILS")}
          content={<StatusTable >
            {InformationDeath?.DeathPlace === "HOSPITAL" && (
              <div className="row">
                <div className="col-md-12">
                  <div className="col-md-12">
                    <h1 className="summaryheadingh">
            ...
            {InformationDeath?.DeathPlace === "INSTITUTION" && (
              <div className="row">
                <div className="col-md-12">
                  <div className="col-md-12">
                    <h1 className="summaryheadingh">
            ...
            {InformationDeath?.DeathPlace === "HOME" && (
              <div className="row">
                <div className="col-md-12">
                  <div className="col-md-12">
                    <h1 className="summaryheadingh">
            ...
            {InformationDeath?.DeathPlace === "VEHICLE" && (
              <div className="row">
                <div className="col-md-12">
                  <div className="col-md-12">
                    <h1 className="summaryheadingh">
            ...
            {InformationDeath?.DeathPlace === "PUBLIC_PLACES" && (
              <div className="row">
                <div className="col-md-12">
                  <div className="col-md-12">
                    <h1 className="summaryheadingh">
            ...
            {InformationDeath?.DeathPlace === "OUTSIDE_JURISDICTION" && (
              <div className="row">
                <div className="col-md-12">
                  <div className="col-md-12">
                    <h1 className="summaryheadingh">
            ...
            <div className="row">
              <div className="col-md-12">
                ...
                <div className="col-md-6">
                  <CardText style={{ fontSize: "15px", Colour: "black", textAlign: "left" }}>{InformationDeath?.DeathPlace}</CardText>
                </div>
              </div>
            </div>
            {InformationDeath?.DeathPlace === "HOSPITAL" && (
