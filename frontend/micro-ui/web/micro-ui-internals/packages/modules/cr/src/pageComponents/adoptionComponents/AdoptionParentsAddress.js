...
const AdoptionParentsAddress = ({ config, onSelect, userType, formData }) => {
  ...
  const [PresentCountry, setPresentCountry] = useState(formData?.AdoptionParentsAddressDetails?.PresentCountry);
  const [PresentStateName, setPresentStateName] = useState(formData?.AdoptionParentsAddressDetails?.PresentStateName);
  const [PresentDistrict, setPresentDistrict] = useState(formData?.AdoptionParentsAddressDetails?.PresentDistrict);
  const [PresentLBTypeName, setPresentLBTypeName] = useState(formData?.AdoptionParentsAddressDetails?.PresentLBTypeName);
  const [PresentLBName, setPresentLBName] = useState(formData?.AdoptionParentsAddressDetails?.PresentLBName);
  // const [PresentWardNo, setPresentWardNo] = useState(formData.AddressPresentDetails?.Presentwardno);
  const [PresentTaluk, setPresentTaluk] = useState(formData?.AdoptionParentsAddressDetails?.PresentTaluk);
  const [PresentPostOffice, setPresentPostOffice] = useState(formData?.AdoptionParentsAddressDetails?.PresentPostOffice);
  const [PresentPincode, setPresentPincode] = useState(formData?.AdoptionParentsAddressDetails?.PresentPincode);
  const [PresentHouseNameEn, setPresentHouseNameEn] = useState(formData?.AdoptionParentsAddressDetails?.PresentHouseNameEn);
  const [PresentHouseNameMl, setPresentHouseNameMl] = useState(formData?.AdoptionParentsAddressDetails?.PresentHouseNameMl);
  const [PresentBuldingNo, setPresentBuldingNo] = useState(formData?.AdoptionParentsAddressDetails?.PresentBuldingNo);
  const [PresentDoorNo, setPresentDoorNo] = useState(formData?.AdoptionParentsAddressDetails?.PresentDoorNo);
  const [PresentResNo, setPresentResNo] = useState(formData?.AdoptionParentsAddressDetails?.PresentResNo);
  const [PresentMainPlaceEn, setPresentMainPlaceEn] = useState(formData?.AdoptionParentsAddressDetails?.PresentMainPlaceEn);
  const [PresentMainPlaceMl, setPresentMainPlaceMl] = useState(formData?.AdoptionParentsAddressDetails?.PresentMainPlaceMl);
  const [PresentLocalityNameEn, setPresentLocalityNameEn] = useState(formData?.AdoptionParentsAddressDetails?.PresentLocalityNameEn);
  const [PresentLocalityNameMl, setPresentLocalityNameMl] = useState(formData?.AdoptionParentsAddressDetails?.PresentLocalityNameMl);
  const [PresentStreetNameEn, setPresentStreetNameEn] = useState(formData?.AdoptionParentsAddressDetails?.PresentStreetNameEn);
  const [PresentStreetNameMl, setPresentStreetNameMl] = useState(formData?.AdoptionParentsAddressDetails?.PresentStreetNameMl);
  const [PresentVillage, setPresentVillage] = useState(formData?.AdoptionParentsAddressDetails?.PresentVillage);
  const [isPrsentAddress, setIsPrsentAddress] = useState(formData?.AdoptionParentsAddressDetails?.isPrsentAddress);
  const [PermanentCountry, setPermanentCountry] = useState(formData?.AdoptionParentsAddressDetails?.PermanentCountry);
  const [PermanentStateName, setPermanentStateName] = useState(formData?.AdoptionParentsAddressDetails?.PermanentStateName);
  const [PermanentDistrict, setPermanentDistrict] = useState(formData?.AdoptionParentsAddressDetails?.PermanentDistrict);
  const [PermanentLBTypeName, setPermanentLBTypeName] = useState(formData?.AdoptionParentsAddressDetails?.PermanentLBTypeName);
  const [PermanentLBName, setPermanentLBName] = useState(formData?.AdoptionParentsAddressDetails?.PermanentLBName);
  // const [PermanentWardNo, setPermanentWardNo] = useState(formData.AddressPresentDetails?.Presentwardno);
  const [PermanentVillage, setPermanentVillage] = useState(formData?.AdoptionParentsAddressDetails?.PermanentVillage);
  const [PermanentTaluk, setPermanentTaluk] = useState(formData?.AdoptionParentsAddressDetails?.PermanentTaluk);
  const [PermanentPostOffice, setPermanentPostOffice] = useState(formData?.AdoptionParentsAddressDetails?.PermanentPostOffice);
  const [PermanentPincode, setPermanentPincode] = useState(formData?.AdoptionParentsAddressDetails?.PermanentPincode);
  const [PermanentBuldingNo, setPermanentBuldingNo] = useState(formData?.AdoptionParentsAddressDetails?.PermanentBuldingNo);
  const [PermanentDoorNo, setPermanentDoorNo] = useState(formData?.AdoptionParentsAddressDetails?.PermanentDoorNo);
  const [PermanentResNo, setPermanentResNo] = useState(formData?.AdoptionParentsAddressDetails?.PermanentResNo);
  const [PermanentHouseNameEn, setPermanentHouseNameEn] = useState(formData?.AdoptionParentsAddressDetails?.PermanentHouseNameEn);
  const [PermanentHouseNameMl, setPermanentHouseNameMl] = useState(formData?.AdoptionParentsAddressDetails?.PermanentHouseNameMl);
  const [PermanentMainPlaceEn, setPermanentMainPlaceEn] = useState(formData?.AdoptionParentsAddressDetails?.PermanentMainPlaceEn);
  const [PermanentMainPlaceMl, setPermanentMainPlaceMl] = useState(formData?.AdoptionParentsAddressDetails?.PermanentMainPlaceMl);
  const [PermanentLocalityNameEn, setPermanentLocalityNameEn] = useState(formData?.AdoptionParentsAddressDetails?.PermanentLocalityNameEn);
  const [PermanentLocalityNameMl, setPermanentLocalityNameMl] = useState(formData?.AdoptionParentsAddressDetails?.PermanentLocalityNameMl);
  const [PermanentStreetNameEn, setPermanentStreetNameEn] = useState(formData?.AdoptionParentsAddressDetails?.PermanentStreetNameEn);
  const [PermanentStreetNameMl, setPermanentStreetNameMl] = useState(formData?.AdoptionParentsAddressDetails?.PermanentStreetNameMl);
