  ...
  return (
    <React.Fragment>
      ...
      <Card>
        ...
        <CardSubHeader style={{ marginLeft: "18px", marginBottom: "16px", fontSize: "16px", color: "#00377B" }} >{t("CR_STILLBIRTH_REG_SUMMARY_HEADING")}</CardSubHeader>
        <Accordion expanded={true} title={t("CR_BIRTH_CHILD_DETAILS")}
          content={<StatusTable >
            ...
            <div className="row">
              <div className="col-md-12">
                ...
                <div className="col-md-8">
                  <CardText className="summarySubHeading">:{convertEpochToDate(StillBirthChildDetails?.childDOB)}</CardText>
                </div>
              </div>
            </div>
            <div className="row">
              <div className="col-md-12">
                ...
                <div className="col-md-8">
                  <CardText className="summarySubHeading"> : {StillBirthChildDetails?.displaytime ? StillBirthChildDetails?.displaytime + " " + StillBirthChildDetails?.displayAmPm : "NOT_RECORDED"}
            ...
            {/* <div className="col-md-2">
                  <CardText className="summaryHeading">{StillBirthChildDetails?.birthDateTime ? StillBirthChildDetails?.birthDateTime : "NOT_RECORDED"}</CardText>
                </div> */}
            <div className="row">
              <div className="col-md-12">
                <div className="col-md-4">
                ...
                <div className="col-md-8">
                  <CardText className="summarySubHeading">:  {StillBirthChildDetails?.gender.code}</CardText>
                </div>
              </div>
            </div>
            <div className="row">
          ...
          content={<StatusTable >
            ...
            <div className="row">
              <div className="col-md-12">
                ...
                <div className="col-md-8">
                  <CardText className="summarySubHeading">:{StillBirthChildDetails?.birthPlace.name}</CardText>
              ...
              <div>
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-8">
                      <CardText className="summarySubHeading">: {StillBirthChildDetails?.hospitalName.hospitalName}</CardText>
                    </div>
                  </div>
                </div>
                <div className="row">
              ...
              <div>
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-8">
                      <CardText className="summarySubHeading">:{StillBirthChildDetails?.institution.name}</CardText>
                    </div>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-8">
                      <CardText className="summarySubHeading"> : {StillBirthChildDetails?.institutionId.institutionName}</CardText>
                    </div>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-6">
                      <CardText className="summarySubHeading"> :{StillBirthChildDetails?.institutionId.institutionNamelocal}</CardText>
                      {/* <div className="col-md-2">
              ...
              <div>
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-8">
                      <CardText className="summarySubHeading">:{StillBirthChildDetails?.wardNo.namecmb}</CardText>
                    </div>
                  </div>
                </div>
                ...
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-8">
                      <CardText className="summarySubHeading"> : {StillBirthChildDetails?.adrsPostOffice.name}</CardText>
                    </div>
                  </div>
                </div>
                ...
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-8">
                      <CardText className="summarySubHeading"> : {StillBirthChildDetails?.adrsPincode}</CardText>
                    </div>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-8">
                      <CardText className="summarySubHeading"> : {StillBirthChildDetails?.adrsLocalityNameEn}</CardText>
                    </div>
                  </div>
                </div>
                ...
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-8">
                      <CardText className="summarySubHeading"> : {StillBirthChildDetails?.adrsLocalityNameMl}</CardText>
                    </div>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-8">
                      <CardText className="summarySubHeading"> : {StillBirthChildDetails?.adrsStreetNameEn}</CardText>
                    </div>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-8">
                      <CardText className="summarySubHeading"> : {StillBirthChildDetails?.adrsStreetNameMl}</CardText>
                    </div>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-8">
                      <CardText className="summarySubHeading"> :{StillBirthChildDetails?.adrsHouseNameEn}</CardText>
                    </div>
                  </div>
                </div>
                ...
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-8">
                      <CardText className="summarySubHeading"> : {StillBirthChildDetails?.adrsHouseNameMl}</CardText>
              ...
              <div>
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-8">
                      <CardText className="summarySubHeading"> : {StillBirthChildDetails?.vehicleType.name}</CardText>
                    </div>
                  </div>
                </div>
                ...
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-8">
                      <CardText className="summarySubHeading"> : {StillBirthChildDetails?.vehicleRegistrationNo}</CardText>
                    </div>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-12">
                    <div className="col-md-4">
                      <CardText className="summaryHeading">{`${t("CR_VEHICLE_PLACE_FIRST_HALT_EN")}`} </CardText>
                    </div>
                    <div className="col-md-8">
                      <CardText className="summarySubHeading"> : {StillBirthChildDetails?.vehicleHaltPlace}</CardText>
                    </div>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-8">
                      <CardText className="summarySubHeading"> : {StillBirthChildDetails?.vehicleFromEn}</CardText>
                    </div>
                  </div>
                </div>
                ...
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-8">
                      <CardText className="summarySubHeading"> : {StillBirthChildDetails?.vehicleToEn}</CardText>
                    </div>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-8">
                      <CardText className="summarySubHeading"> : {StillBirthChildDetails?.vehicleFromMl}</CardText>
                    </div>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-8">
                      <CardText className="summarySubHeading"> : {StillBirthChildDetails?.vehicleToMl}</CardText>
                    </div>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-8">
                      <CardText className="summarySubHeading"> : {StillBirthChildDetails?.setadmittedHospitalEn.hospitalName}</CardText>
                    </div>
                  </div>
                </div>
                <div className="row">
                ...
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-8">
                      <CardText className="summarySubHeading">{StillBirthChildDetails?.vehicleDesDetailsEn}</CardText>
              ...
              <div>
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-8">
                      <CardText className="summarySubHeading"> : {StillBirthChildDetails?.publicPlaceType.name}</CardText>
                    </div>
                  </div>
                </div>
                ...
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-8">
                      <CardText className="summarySubHeading"> :{StillBirthChildDetails?.localityNameEn}</CardText>
                    </div>
                  </div>
                </div>
                ...
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-8">
                      <CardText className="summarySubHeading"> : {StillBirthChildDetails?.localityNameMl}</CardText>
                    </div>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-8">
                      <CardText className="summarySubHeading"> :{StillBirthChildDetails?.streetNameEn}</CardText>
                    </div>
                  </div>
                </div>
                ...
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-8">
                      <CardText className="summarySubHeading"> : {StillBirthChildDetails?.streetNameMl}</CardText>
                    </div>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-8">
                      <CardText className="summarySubHeading"> :{StillBirthChildDetails?.publicPlaceDecpEn}</CardText>
          ...
          content={<StatusTable >
            ...
            <div className="row">
              <div className="col-md-12">
                ...
                <div className="col-md-8">
                  <CardText className="summarySubHeading">: {locale === "en_IN" ? StillBirthChildDetails?.medicalAttensionSub?.name : locale === "ml_IN" ? StillBirthChildDetails?.medicalAttensionSub?.namelocal : StillBirthChildDetails?.medicalAttensionSub?.name}</CardText>
                </div>
              </div>
            </div>
            <div className="row">
              <div className="col-md-12">
                ...
                <div className="col-md-8">
                  <CardText className="summarySubHeading"> :{StillBirthChildDetails?.pregnancyDuration}</CardText>
            ...
            <div className="row">
              <div className="col-md-12">
                ...
                <div className="col-md-4">
                  <CardText className="summarySubHeading"> :{locale === "en_IN" ? StillBirthChildDetails?.deliveryMethods?.name : locale === "ml_IN" ? StillBirthChildDetails?.deliveryMethods?.namelocal : StillBirthChildDetails?.deliveryMethods?.name}</CardText>
                </div>
              </div>
            </div>
            <div className="row">
          ...
          content={<StatusTable >
            ...
            {StillBirthParentsDetails?.isMotherInfo === true && (
              <div className="row">
                <div className="col-md-12">
                  <div className="col-md-4">
                    <CardText className="summaryHeading">{`${t("CR_MOTHER_INFORMATION_MISSING")}`} :</CardText>
                  </div>
                </div>
              </div>
            )}
              ...
              <div>
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-4">
                      <CardText className="summarySubHeading"> :{StillBirthParentsDetails?.motherAadhar}</CardText>
                    </div>
                  </div>
                </div>
                ...
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-4">
                      <CardText className="summarySubHeading"> :{StillBirthParentsDetails?.motherFirstNameEn}</CardText>
                    </div>
                  </div>
                </div>
                ...
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-4">
                      <CardText className="summarySubHeading">:{StillBirthParentsDetails?.motherFirstNameMl}</CardText>
                    </div>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-4">
                      <CardText className="summarySubHeading">: {locale === "en_IN" ? StillBirthParentsDetails?.motherNationality?.nationalityname : locale === "ml_IN" ? StillBirthParentsDetails?.motherNationality?.nationalitynamelocal : StillBirthParentsDetails?.motherNationality?.nationalityname}</CardText>
                    </div>
                ...
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-4">
                      <CardText className="summarySubHeading">: {StillBirthParentsDetails?.motherMarriageBirth}</CardText>
                    </div>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-4">
                      <CardText className="summarySubHeading"> :{locale === "en_IN" ? StillBirthParentsDetails?.motherEducation?.name : locale === "ml_IN" ? StillBirthParentsDetails?.motherEducation?.namelocal : StillBirthParentsDetails?.motherEducation?.name}
                      </CardText>
                    </div>
                  </div>
                </div>
            ...
            {StillBirthParentsDetails?.isFatherInfo === true && (
              <div className="row">
                <div className="col-md-12">
                  <div className="col-md-6">
                    <CardText className="summarySubHeading">{`${t("CR_FATHER_INFORMATION_MISSING")}`} :</CardText>
                  </div>
                </div>
              </div>
            )}
              ...
              <div>
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-4">
                      <CardText className="summarySubHeading"> :{StillBirthParentsDetails?.fatherAadhar}</CardText>
                    </div>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-4">
                      <CardText className="summarySubHeading"> : {StillBirthParentsDetails?.fatherFirstNameEn}</CardText>
                    </div>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-4">
                      <CardText className="summarySubHeading">: {StillBirthParentsDetails?.fatherFirstNameMl}</CardText>
                    </div>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-4">
                      <CardText className="summarySubHeading"> : {locale === "en_IN" ? StillBirthParentsDetails?.fatherNationality?.nationalityname : locale === "ml_IN" ? StillBirthParentsDetails?.fatherNationality?.nationalitynamelocal : StillBirthParentsDetails?.fatherNationality?.nationalityname}
                      </CardText>
                    </div>
                  </div>
                </div>
                ...
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-4">
                      <CardText className="summarySubHeading"> : {locale === "en_IN" ? StillBirthParentsDetails?.fatherEducation?.name : locale === "ml_IN" ? StillBirthParentsDetails?.fatherEducation?.namelocal : StillBirthParentsDetails?.fatherEducation?.name}
                      </CardText>
                    </div>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-4">
                      <CardText className="summarySubHeading"> : {locale === "en_IN" ? StillBirthParentsDetails?.fatherProfession?.name : locale === "ml_IN" ? StillBirthParentsDetails?.fatherProfession?.namelocal : StillBirthParentsDetails?.fatherProfession?.name}
                      </CardText>
                    </div>
                  </div>
                </div>
            ...
            <div className="row">
              <div className="col-md-12">
                ...
                <div className="col-md-4">
                  <CardText className="summarySubHeading"> :{locale === "en_IN" ? StillBirthParentsDetails?.Religion?.name : locale === "ml_IN" ? StillBirthParentsDetails?.Religion?.namelocal : StillBirthParentsDetails?.Religion?.name}</CardText>
                </div>
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-md-12">
                ...
                <div className="col-md-4">
                  <CardText className="summarySubHeading"> : {StillBirthParentsDetails?.fatherMobile}</CardText>
                </div>
              </div>
            </div>
            <div className="row">
              <div className="col-md-12">
                ...
                <div className="col-md-4">
                  <CardText className="summarySubHeading"> : {StillBirthParentsDetails?.fatherEmail} </CardText>
                    ...
                    <div>
                      ...
                      <div className="row">
                        <div className="col-md-12">
                          ...
                          <div className="col-md-4">
                            <CardText className="summarySubHeading"> :{StillBirthInitiatorDetails?.initiatorAadhar}</CardText>
                          </div>
                        </div>
                      </div>
                      <div className="row">
                        <div className="col-md-12">
                          ...
                          <div className="col-md-4">
                            <CardText className="summarySubHeading"> : {StillBirthInitiatorDetails?.initiatorNameEn}</CardText>
                          </div>
                        </div>
                      </div>
                      <div className="row">
                        <div className="col-md-12">
                          ...
                          <div className="col-md-4">
                            <CardText className="summarySubHeading"> : {StillBirthInitiatorDetails?.initiatorMobile}</CardText>
                          </div>
                        </div>
                      </div>
                      <div className="row">
                        <div className="col-md-12">
                          ...
                          <div className="col-md-6">
                            <CardText className="summarySubHeading"> : {StillBirthInitiatorDetails?.initiatorAddress}</CardText>
                          </div>
                    ...
                    <div>
                      ...
                      <div className="row">
                        <div className="col-md-12">
                          ...
                          <div className="col-md-4">
                            <CardText className="summarySubHeading"> : {StillBirthInitiatorDetails?.initiatorInstitutionName}</CardText>
                          </div>
                        </div>
                      </div>
                      <div className="row">
                ...
                <StatusTable>
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      ...
                      <div className="col-md-4">
                        <CardText className="summarySubHeading"> : {StillBirthInformarDetails?.infomantAadhar}</CardText>
                      </div>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-md-12">
                      ...
                      <div className="col-md-4">
                        <CardText className="summarySubHeading"> : {StillBirthInformarDetails?.infomantFirstNameEn}</CardText>
                      </div>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-md-12">
                      ...
                      <div className="col-md-4">
                        <CardText className="summarySubHeading"> :{StillBirthInformarDetails?.informerDesi}</CardText>
                      </div>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-md-12">
                      ...
                      <div className="col-md-4">
                        <CardText className="summarySubHeading"> :{StillBirthInformarDetails?.infomantMobile}</CardText>
                      </div>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-md-12">
                      ...
                      <div className="col-md-4">
                        <CardText className="summarySubHeading"> : {StillBirthInformarDetails?.informerAddress}</CardText>
                      </div>
              ...
              <StatusTable>
                ...
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-4">
                      <CardText className="summarySubHeading"> :{locale === "en_IN" ? StillBirthInitiatorDetails?.ipopList?.name : locale === "ml_IN" ? StillBirthInitiatorDetails?.ipopList?.namelocal : StillBirthInitiatorDetails?.ipopList?.name}
                      </CardText>
                    </div>
                  </div>
                </div>
                ...
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-4">
                      <CardText className="summarySubHeading"> :{StillBirthInitiatorDetails?.ipopNumber}</CardText>
                    </div>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-4">
                      <CardText className="summarySubHeading"> : {StillBirthInitiatorDetails?.obstetricsNumber}</CardText>
                    </div>
        ...
        <div>
          ...
          <div className="row">
            <div className="col-md-12">
              <h1 className="summaryheadingh">
                <span style={{ background: "#fff" }}>{`${t("CR_DECLARATION_DOCUMENTS")}`}</span>{" "}
              </h1>
            </div>
          </div>
