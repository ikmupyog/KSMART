              ...
              <div className="col-md-12">
                ...
                <div className="col-md-3">
                    <CardText style={{ fontSize: "15px", Colour: "black", textAlign: "left" }}>
                      {locale === "en_IN" ? StillBirthChildDetails?.medicalAttensionSub?.name : locale === "ml_IN" ? StillBirthChildDetails?.medicalAttensionSub?.namelocal : StillBirthChildDetails?.medicalAttensionSub?.name}</CardText>
                  </div>
        ...
        <StatusTable>
          ...
          <div className="row">
            <div className="col-md-12">
              ...
              <div className="col-md-2">
                <CardText style={{ fontSize: "15px", Colour: "black", textAlign: "left" }}>
                  {locale === "en_IN" ? StillBirthInitiatorDetails?.ipopList?.name : locale === "ml_IN" ? StillBirthInitiatorDetails?.ipopList?.namelocal : StillBirthInitiatorDetails?.ipopList?.name}
                </CardText>
              </div>
              <div className="col-md-2">
