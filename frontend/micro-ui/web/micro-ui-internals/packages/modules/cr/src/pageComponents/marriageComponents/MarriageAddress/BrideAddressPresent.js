...
const BrideAddressPresent = ({ config, onSelect, userType, formData, presentaddressCountry, setaddressCountry,
    ...
    useEffect(() => {
        if (isInitialRender && countryvalue === "IND" && value === "kl" &&
            ...
            (formData?.BrideAddressDetails?.presentaddressStateName === null || formData?.BrideAddressDetails?.presentaddressStateName === "" ||
