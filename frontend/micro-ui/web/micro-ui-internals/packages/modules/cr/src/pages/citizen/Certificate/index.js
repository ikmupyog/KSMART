...
const DeathCertificateSearch = ({path}) => {
    ...
    return  (
        <React.Fragment>
            ...
            <DeathCertificate t={t} tenantId={tenantId} onSubmit={onSubmit} data={!isLoading && isSuccess ? (searchReult?.length > 0 ? searchReult : { display: "ES_COMMON_NO_DATA" }) : ""} filestoreId={storeId} isSuccess={isSuccess} isLoading={isLoading} count={count}/>
        </React.Fragment>
    )
