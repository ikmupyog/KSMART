...
const Vehicle = ({ config, onSelect, userType, formData ,DeathPlaceType, setSelectedDeathPlaceType,VehicleNumber, setVehicleNumber,
  VehicleFromplaceEn, setVehicleFromplaceEn,VehicleToPlaceEn, setVehicleToPlaceEn,VehicleFromplaceMl, setVehicleFromplaceMl,
  GeneralRemarks, setGeneralRemarks,VehicleFirstHaltEn, setVehicleFirstHaltEn,VehicleFirstHaltMl, setVehicleFirstHaltMl,
  VehicleHospitalEn, setSelectedVehicleHospitalEn}) => {
