...
const AdoptionFatherInformation = ({ config, onSelect, userType, formData }) => {
  ...
  const [MotherFirstNameEn, setMotherFirstNameEn] = useState(formData?.AdoptionFatherInfoDetails?.MotherFirstNameEn);
  const [MotherMiddleNameEn, setMotherMiddleNameEn] = useState(formData?.AdoptionFatherInfoDetails?.MotherMiddleNameEn);
  const [MotherLastNameEn, setMotherLastNameEn] = useState(formData?.AdoptionFatherInfoDetails?.MotherLastNameEn);
  const [MotherFirstNameMl, setMotherFirstNameMl] = useState(formData?.AdoptionFatherInfoDetails?.MotherFirstNameMl);
  const [MotherMiddleNameMl, setMotherMiddleNameMl] = useState(formData?.AdoptionFatherInfoDetails?.MotherMiddleNameMl);
  const [MotherLastNameMl, setMotherLastNameMl] = useState(formData?.AdoptionFatherInfoDetails?.MotherLotherPlaceNameastNameMl);
  const [MotherAadhar, setMotherAadhar] = useState(formData?.AdoptionFatherInfoDetails?.MotherAadhar);
  const [MotherPassportNo, setMotherPassportNo] = useState(formData?.AdoptionFatherInfoDetails?.MotherPassportNo);
  const [MotherEmail, setMotherEmail] = useState(formData?.AdoptionFatherInfoDetails?.MotherEmail);
  const [MotherMobile, setMotherMobile] = useState(formData?.AdoptionFatherInfoDetails?.MotherMobile);
  const [MotherEducation, setMotherEducation] = useState(formData?.AdoptionFatherInfoDetails?.MotherEducation);
  // const [MotherEducationSubject, setMotherEducationSubject] = useState(formData?.AdoptionFatherInfoDetails?.MotherEducationSubject);
  const [MotherProfession, setMotherProfession] = useState(formData?.AdoptionFatherInfoDetails?.MotherProfession);
  const [LBTypeName, setLBTypeName] = useState(formData?.AdoptionFatherInfoDetails?.LBTypeName);
  const [StateName, setStateName] = useState(formData?.AdoptionFatherInfoDetails?.StateName);
  const [MotherDistrict, setMotherDistrict] = useState(formData?.AdoptionFatherInfoDetails?.MotherDistrict);   
  const [MotherNationality, setMotherNationality] = useState(formData?.AdoptionFatherInfoDetails?.MotherNationality);  
...
export default AdoptionFatherInformation;
