...
const AdoptionFatherInformation = ({ config, onSelect, userType, formData }) => {
    ...
    const [FatherFirstNameEn, setFatherFirstNameEn] = useState(formData?.AdoptionFatherInfoDetails?.FatherFirstNameEn);
    const [FatherMiddleNameEn, setFatherMiddleNameEn] = useState(formData?.AdoptionFatherInfoDetails?.FatherMiddleNameEn);
    const [FatherLastNameEn, setFatherLastNameEn] = useState(formData?.AdoptionFatherInfoDetails?.FatherLastNameEn);
    const [FatherFirstNameMl, setFatherFirstNameMl] = useState(formData?.AdoptionFatherInfoDetails?.FatherFirstNameMl);
    const [FatherMiddleNameMl, setFatherMiddleNameMl] = useState(formData?.AdoptionFatherInfoDetails?.FatherMiddleNameMl);
    const [FatherLastNameMl, setFatherLastNameMl] = useState(formData?.AdoptionFatherInfoDetails?.FatherLastNameMl);
    const [FatherAadhar, setFatherAadhar] = useState(formData?.AdoptionFatherInfoDetails?.FatherAadhar);
    const [FatherPassportNo, setFatherPassportNo] = useState(formData?.AdoptionFatherInfoDetails?.FatherPassportNo);
    const [FatherEmail, setFatherEmail] = useState(formData?.AdoptionFatherInfoDetails?.FatherEmail);
    const [FatherMobile, setFatherMobile] = useState(formData?.AdoptionFatherInfoDetails?.FatherMobile);
    const [FatherEducation, setFatherEducation] = useState(formData?.AdoptionFatherInfoDetails?.FatherEducation);
    const [FatherEducationSubject, setFatherEducationSubject] = useState(formData?.AdoptionFatherInfoDetails?.FatherEducationSubject);
    const [FatherProfession, setFatherProfession] = useState(formData?.AdoptionFatherInfoDetails?.FatherProfession);
    const [FatherNationality, setFatherNationality] = useState(formData?.AdoptionFatherInfoDetails?.FatherNationality);
