              ...
              <div>
                ...
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-3">
                      <CardLabel>{t("CR_HOUSE_NO_NAME_ENG")} </CardLabel>
                      <TextInput
                        t={t}
                        isMandatory={false}
                        type={"text"}
                ...
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-3">
                      <CardLabel>{t("CR_HOUSE_NO_NAME_ML")}</CardLabel>
                      <TextInput
                        t={t}
                        isMandatory={false}
                        type={"text"}
                      ...
                      <div className="col-md-3">
                        ...
                        <TextInput
                          ...
                          {...(validation = {
                            ...
                            isRequired: true,
                            type: "text",
                            title: t("CR_INVALID_MAIN_PLACE_ML"),
                          })}
                        />
                      </div>
                      <div className="col-md-3">
                        <CardLabel>{t("CR_HOUSE_NO_NAME")} </CardLabel>
                        <TextInput
                          t={t}
                          isMandatory={false}
                          type={"text"}
