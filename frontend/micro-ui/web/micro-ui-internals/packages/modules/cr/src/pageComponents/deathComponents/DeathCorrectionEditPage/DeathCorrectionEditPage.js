              ...
              <FieldComponentContainer>
                <div className="col-md-4">
                  ...
                  <TextInput
                    ...
                    {...(validation = { pattern: "^[\u0D00-\u0D7F\u200D\u200C .&'@']*$", type: "text", isRequired: deathCorrectionFormsObj?.DECEASED_NAME?.isEditable, title: t("CR_INVALID_FIRST_NAME_ML") })}
                  />
                </div>
                <div className="col-md-4">
              ...
              <FieldComponentContainer>
                ...
                <div className="col-md-4">
                  ...
                  <TextInput
                    ...
                    {...(validation = { pattern: "^[\u0D00-\u0D7F\u200D\u200C .&'@']*$", type: "text", isRequired: deathCorrectionFormsObj.DECEASED_MOTHER?.isEditable, title: t("CR_INVALID_MOTHER_NAME_ML") })}
                  />
                </div>
              </FieldComponentContainer>
              <div style={{ marginTop: "2.2rem" }}>
