          ...
          content={<StatusTable >
            ...
            <div className="row">
              <div className="col-md-12">
                ...
                <div className="col-md-2">
                  <CardText style={{ fontSize: "15px", Colour: "black", textAlign: "left" }}>{ChildDetails?.birthDateTime ? ChildDetails?.birthDateTime : "NA"}</CardText>
                </div>
                <div className="col-md-2">
            ...
            {ChildDetails?.birthPlace.code === "HOSPITAL" && (
              <div className="row">
                <div className="col-md-12">
                  ...
                  <div className="col-md-3">
                    <CardText style={{ fontSize: "15px", Colour: "black", textAlign: "left" }}>{ChildDetails?.hospitalName.hospitalNamelocal}</CardText>
                  </div>
                </div>
              </div>
            )}
              ...
              <div>
                ...
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-3">
                      <CardText style={{ fontSize: "15px", Colour: "black", textAlign: "left" }}>{ChildDetails?.institutionId.institutionName}</CardText>
                    </div>
                    <div className="col-md-3">
                      <CardText style={{ fontSize: "15px", Colour: "black", textAlign: "left" }}>{`${t("CR_INSTITUTION_NAME_ML")}`} :</CardText>
                    </div>
                    <div className="col-md-3">
                      <CardText style={{ fontSize: "15px", Colour: "black", textAlign: "left" }}>{ChildDetails?.institutionId.institutionNamelocal}</CardText>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-3">
                      <CardText style={{ fontSize: "15px", Colour: "black", textAlign: "left" }}>{ChildDetails?.setadmittedHospitalEn.hospitalName}</CardText>
                    </div>
                    <div className="col-md-3">
                      <CardText style={{ fontSize: "15px", Colour: "black", textAlign: "left" }}>{`${t("CS_COMMON_WARD")}`} :</CardText>
                    </div>
              ...
              <div>
                ...
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-2">
                      <CardText style={{ fontSize: "15px", Colour: "black", textAlign: "left" }}>{ParentsDetails?.motherNationality.nationalityname}</CardText>
                    </div>
                    <div className="col-md-2">
                      <CardText style={{ fontSize: "15px", Colour: "black", textAlign: "left" }}>{`${t("CR_MOTHER_MARITAL_STATUS")}`} :</CardText>
                    </div>
                    <div className="col-md-2">
                      <CardText style={{ fontSize: "15px", Colour: "black", textAlign: "left" }}>{ParentsDetails?.motherMaritalStatus.code}</CardText>
                    </div>
                  </div>
                </div>
                <div className="row">
              ...
              <div>
                ...
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-2">
                      <CardText style={{ fontSize: "15px", Colour: "black", textAlign: "left" }}>{ParentsDetails?.fatherNationality.nationalityname}</CardText>
                    </div>
                    <div className="col-md-2">
                      <CardText style={{ fontSize: "15px", Colour: "black", textAlign: "left" }}>{`${t("CR_EDUCATION")}`} :</CardText>
                    </div>
