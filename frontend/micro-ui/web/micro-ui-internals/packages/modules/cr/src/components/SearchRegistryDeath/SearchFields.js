...
const SearchFields = ({ register, control, reset, tenantId, t,previousPage }) => {
    ...
    return <>
        ...
        <SearchField>
            <label> <span className="mandatorycss">*</span>
        ...
        <SearchField>
            <label><span className="mandatorycss">*</span>{t("DC_GENDER")}</label>
            <Controller
                control={control}
                name="Gender"
                render={(props) => (
        ...
        <SearchField>
            <label>{t("DC_NAME_FATHER_OR_HUSBAND")}</label>
            <TextInput name="HusbandorfatherName" inputRef={register({})}
