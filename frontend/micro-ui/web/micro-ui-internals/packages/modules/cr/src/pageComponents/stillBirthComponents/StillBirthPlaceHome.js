...
const StillBirthPlaceHome = ({ config, onSelect, userType, formData,
  ...
  function setSelectAdrsHouseNameEn(e) {
    if (e.target.value.trim().length >= 0 && e.target.value.trim() !== "." && (e.target.value.match("^[a-zA-Z-0-9 ]*$") != null)) {
      setAdrsHouseNameEn(e.target.value.length <= 150 ? e.target.value : (e.target.value).substring(0, 150));
    }
  }
  function setSelectAdrsHouseNameMl(e) {
    ...
    if (!(e.target.value.match(pattern))) {
      ...
      setAdrsHouseNameMl(e.target.value.length <= 150 ? e.target.value : (e.target.value).substring(0, 150));
    }
  }

  function setSelectAdrsLocalityNameEn(e) {
    if (e.target.value.trim().length >= 0 && e.target.value.trim() !== "." && (e.target.value.match("^[a-zA-Z ]*$") != null)) {
      setAdrsLocalityNameEn(e.target.value.length <= 150 ? e.target.value : (e.target.value).substring(0, 150));
    }
  }
  function setSelectAdrsLocalityNameMl(e) {
    ...
    if (!(e.target.value.match(pattern))) {
      ...
      setAdrsLocalityNameMl(e.target.value.length <= 150 ? e.target.value : (e.target.value).substring(0, 150));
    }
  }

  function setSelectAdrsStreetNameEn(e) {
    if (e.target.value.trim().length >= 0 && e.target.value.trim() !== "." && (e.target.value.match("^[a-zA-Z ]*$") != null)) {
      setAdrsStreetNameEn(e.target.value.length <= 150 ? e.target.value : (e.target.value).substring(0, 150));
    }
  }
  function setSelectAdrsStreetNameMl(e) {
    ...
    if (!(e.target.value.match(pattern))) {
      ...
      setAdrsStreetNameMl(e.target.value.length <= 150 ? e.target.value : (e.target.value).substring(0, 150));
    }
  }
