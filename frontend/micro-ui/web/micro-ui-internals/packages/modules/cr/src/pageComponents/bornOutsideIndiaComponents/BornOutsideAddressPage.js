...
const BornOutsideAddressPage = ({ config, onSelect, userType, formData, isEditBornOutsideIndia = false }) => {
  ...
  const [countryvalue, setCountryValue] = useState(
    formData?.BornOutsideAddressBirthDetails?.presentaddressCountry?.code
      ? formData?.BornOutsideAddressBirthDetails?.presentaddressCountry.countrycode
      : formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.presentaddressCountry
      ? ""
      : ""
  );
  const [value, setValue] = useState(
    formData?.BornOutsideAddressBirthDetails?.presentaddressStateName?.code
      ? formData?.BornOutsideAddressBirthDetails?.presentaddressStateName.code
      : formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.presentaddressStateName
      ? ""
      : ""
  );
  ...
  const [TalukDropdownvalues, setTalukDropdownvalues] = useState(null);
  const [VillageDropdownvalues, setVillageDropdownvalues] = useState(null);
  ...
  const [presentOutSideIndiaAdressEn, setAdressEn] = useState(
    formData?.BornOutsideAddressBirthDetails?.presentOutSideIndiaAdressEn
      ? formData?.BornOutsideAddressBirthDetails?.presentOutSideIndiaAdressEn
      : formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.presentOutSideIndiaAdressEn
      ? formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.presentOutSideIndiaAdressEn
      : ""
  );
  ...
  const [presentOutSideIndiaAdressMlB, setAdressMlB] = useState(
    formData?.BornOutsideAddressBirthDetails?.presentOutSideIndiaAdressMlB
      ? formData?.BornOutsideAddressBirthDetails?.presentOutSideIndiaAdressMlB
      : formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.presentOutSideIndiaAdressMlB
      ? formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.presentOutSideIndiaAdressMlB
      : ""
  );
  const [presentOutSideIndiaProvinceEn, setProvinceEn] = useState(
    formData?.BornOutsideAddressBirthDetails?.presentOutSideIndiaProvinceEn
      ? formData?.BornOutsideAddressBirthDetails?.presentOutSideIndiaProvinceEn
      : formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.presentOutSideIndiaProvinceEn
      ? formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.presentOutSideIndiaProvinceEn
      : ""
  );
  const [presentOutSideIndiaProvinceMl, setProvinceMl] = useState(
    formData?.BornOutsideAddressBirthDetails?.presentOutSideIndiaProvinceMl
      ? formData?.BornOutsideAddressBirthDetails?.presentOutSideIndiaProvinceMl
      : formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.presentOutSideIndiaProvinceMl
      ? formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.presentOutSideIndiaProvinceMl
      : ""
  );
  const [presentOutSideIndiaadrsVillage, setadrsVillage] = useState(
    formData?.BornOutsideAddressBirthDetails?.presentOutSideIndiaadrsVillage?.code
      ? formData?.BornOutsideAddressBirthDetails?.presentOutSideIndiaadrsVillage
      : formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.presentOutSideIndiaadrsVillage
      ? ""
      : ""
  );
  const [presentOutSideIndiaadrsCityTown, setadrsCityTown] = useState(
    formData?.BornOutsideAddressBirthDetails?.presentOutSideIndiaadrsCityTown
      ? formData?.BornOutsideAddressBirthDetails?.presentOutSideIndiaadrsCityTown
      : formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.presentOutSideIndiaadrsCityTown
      ? formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.presentOutSideIndiaadrsCityTown
      : ""
  );
  const [presentOutSideIndiaPostCode, setPostCode] = useState(
    formData?.BornOutsideAddressBirthDetails?.presentOutSideIndiaPostCode
      ? formData?.BornOutsideAddressBirthDetails?.presentOutSideIndiaPostCode
      : formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.presentOutSideIndiaPostCode
      ? formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.presentOutSideIndiaPostCode
      : ""
  );
  const [presentOutSideCountry, setOutSideCountry] = useState(
    formData?.BornOutsideAddressBirthDetails?.presentOutSideCountry ? formData?.BornOutsideAddressBirthDetails?.presentOutSideCountry : null
  );
  ...
  const [permtaddressCountry, setpermtaddressCountry] = useState(
    formData?.BornOutsideAddressBirthDetails?.permtaddressCountry?.code
      ? formData?.BornOutsideAddressBirthDetails?.permtaddressCountry
      : formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.permtaddressCountry
      ? ""
      : ""
  );
  const [permtaddressStateName, setpermtaddressStateName] = useState(
    formData?.BornOutsideAddressBirthDetails?.permtaddressStateName?.code
      ? formData?.BornOutsideAddressBirthDetails?.permtaddressStateName
      : formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.permtaddressStateName
      ? ""
      : ""
  );
  const [countryValuePermanent, setCountryValuePermanent] = useState(
    formData?.BornOutsideAddressBirthDetails?.permtaddressCountry?.code
      ? formData?.BornOutsideAddressBirthDetails?.permtaddressCountry.countrycode
      : formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.permtaddressCountry
      ? ""
      : ""
  );
  ...
  const [permntInKeralaAdrDistrict, setpermntInKeralaAdrDistrict] = useState(
    formData?.BornOutsideAddressBirthDetails?.permntInKeralaAdrDistrict?.code
      ? formData?.BornOutsideAddressBirthDetails?.permntInKeralaAdrDistrict
      : formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.permtaddressCountry
      ? ""
      : ""
  );
  const [permntInKeralaAdrLBName, setpermntInKeralaAdrLBName] = useState(
    formData?.BornOutsideAddressBirthDetails?.permntInKeralaAdrLBName?.code
      ? formData?.BornOutsideAddressBirthDetails?.permntInKeralaAdrLBName
      : formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.permntInKeralaAdrLBName
      ? ""
      : ""
  );
  const [permntInKeralaAdrTaluk, setpermntInKeralaAdrTaluk] = useState(
    formData?.BornOutsideAddressBirthDetails?.permntInKeralaAdrTaluk
      ? formData?.BornOutsideAddressBirthDetails?.permntInKeralaAdrTaluk
      : formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.permntInKeralaAdrTaluk
      ? ""
      : ""
  );
  const [permntInKeralaAdrVillage, setpermntInKeralaAdrVillage] = useState(
    formData?.BornOutsideAddressBirthDetails?.permntInKeralaAdrVillage
      ? formData?.BornOutsideAddressBirthDetails?.permntInKeralaAdrVillage
      : formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.permntInKeralaAdrVillage
      ? ""
      : ""
  );
  const [permntInKeralaAdrPostOffice, setpermntInKeralaAdrPostOffice] = useState(
    formData?.BornOutsideAddressBirthDetails?.permntInKeralaAdrPostOffice
      ? formData?.BornOutsideAddressBirthDetails?.permntInKeralaAdrPostOffice
      : formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.permntInKeralaAdrPostOffice
      ? ""
      : ""
  );
  const [permntInKeralaAdrPincode, setpermntInKeralaAdrPincode] = useState(
    formData?.BornOutsideAddressBirthDetails?.permntInKeralaAdrPincode
      ? formData?.BornOutsideAddressBirthDetails?.permntInKeralaAdrPincode
      : formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.permntInKeralaAdrPincode
      ? formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.permntInKeralaAdrPincode
      : ""
  );
  const [permntInKeralaAdrHouseNameEn, setpermntInKeralaAdrHouseNameEn] = useState(
    formData?.BornOutsideAddressBirthDetails?.permntInKeralaAdrHouseNameEn
      ? formData?.BornOutsideAddressBirthDetails?.permntInKeralaAdrHouseNameEn
      : formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.permntInKeralaAdrHouseNameEn
      ? formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.permntInKeralaAdrHouseNameEn
      : ""
  );
  const [permntInKeralaAdrHouseNameMl, setpermntInKeralaAdrHouseNameMl] = useState(
    formData?.BornOutsideAddressBirthDetails?.permntInKeralaAdrHouseNameMl
      ? formData?.BornOutsideAddressBirthDetails?.permntInKeralaAdrHouseNameMl
      : formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.permntInKeralaAdrHouseNameMl
      ? formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.permntInKeralaAdrHouseNameMl
      : ""
  );
  const [permntInKeralaAdrLocalityNameEn, setpermntInKeralaAdrLocalityNameEn] = useState(
    formData?.BornOutsideAddressBirthDetails?.permntInKeralaAdrLocalityNameEn
      ? formData?.BornOutsideAddressBirthDetails?.permntInKeralaAdrLocalityNameEn
      : formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.permntInKeralaAdrLocalityNameEn
      ? formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.permntInKeralaAdrLocalityNameEn
      : ""
  );
  const [permntInKeralaAdrLocalityNameMl, setpermntInKeralaAdrLocalityNameMl] = useState(
    formData?.BornOutsideAddressBirthDetails?.permntInKeralaAdrLocalityNameMl
      ? formData?.BornOutsideAddressBirthDetails?.permntInKeralaAdrLocalityNameMl
      : formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.permntInKeralaAdrLocalityNameMl
      ? formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.permntInKeralaAdrLocalityNameMl
      : ""
  );

  const [permntInKeralaAdrStreetNameEn, setpermntInKeralaAdrStreetNameEn] = useState(
    formData?.BornOutsideAddressBirthDetails?.permntInKeralaAdrStreetNameEn
      ? formData?.BornOutsideAddressBirthDetails?.permntInKeralaAdrStreetNameEn
      : formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.permntInKeralaAdrStreetNameEn
      ? formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.permntInKeralaAdrStreetNameEn
      : ""
  );
  ...
  const [permntInKeralaAdrStreetNameMl, setpermntInKeralaAdrStreetNameMl] = useState(
    formData?.AddressBirthDetails?.permntInKeralaAdrStreetNameMl
      ? formData?.BornOutsideAddressBirthDetails?.permntInKeralaAdrStreetNameMl
      : formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.permntInKeralaAdrStreetNameMl
      ? formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.permntInKeralaAdrStreetNameMl
      : ""
  );

  const [permntInKeralaWardNo, setpermntInKeralaWardNo] = useState(
    formData?.BornOutsideAddressBirthDetails?.permntInKeralaWardNo
      ? formData?.BornOutsideAddressBirthDetails?.permntInKeralaWardNo
      : formData?.BornOutsideChildDetails?.BornOutsideAddressBirthDetails?.permntInKeralaWardNo
      ? ""
      : ""
  );
  ...
  const [PresentAddressCountryError, setPresentAddressCountryError] = useState(
    formData?.BornOutsideAddressBirthDetails?.PresentAddressCountryError ? false : false
  );
  const [PresentAddressStateNameError, setPresentAddressStateNameError] = useState(
    formData?.BornOutsideAddressBirthDetails?.PresentAddressStateNameError ? false : false
  );
  const [PresentInsideKeralaDistrictError, setPresentInsideKeralaDistrictError] = useState(
    formData?.BornOutsideAddressBirthDetails?.PresentInsideKeralaDistrictError ? false : false
  );
  const [PresentInsideKeralaTalukError, setPresentInsideKeralaTalukError] = useState(
    formData?.BornOutsideAddressBirthDetails?.PresentInsideKeralaTalukError ? false : false
  );
  const [PresentInsideKeralaVillageError, setPresentInsideKeralaVillageError] = useState(
    formData?.BornOutsideAddressBirthDetails?.PresentInsideKeralaVillageError ? false : false
  );
  const [PresentInsideKeralaLBNameError, setPresentInsideKeralaLBNameError] = useState(
    formData?.BornOutsideAddressBirthDetails?.PresentInsideKeralaLBNameError ? false : false
  );
  const [PresentInsideKeralaWardNoError, setPresentInsideKeralaWardNoError] = useState(
    formData?.BornOutsideAddressBirthDetails?.PresentInsideKeralaWardNoError ? false : false
  );
  const [PresentInsideKeralaHouseNameEnError, setPresentInsideKeralaHouseNameEnError] = useState(
    formData?.BornOutsideAddressBirthDetails?.PresentInsideKeralaHouseNameEnError ? false : false
  );
  const [PresentInsideKeralaHouseNameMlError, setPresentInsideKeralaHouseNameMlError] = useState(
    formData?.BornOutsideAddressBirthDetails?.PresentInsideKeralaHouseNameMlError ? false : false
  );
  const [PresentInsideKeralaLocalityNameEnError, setPresentInsideKeralaLocalityNameEnError] = useState(
    formData?.BornOutsideAddressBirthDetails?.PresentInsideKeralaLocalityNameEnError ? false : false
  );
  const [PresentInsideKeralaLocalityNameMlError, setPresentInsideKeralaLocalityNameMlError] = useState(
    formData?.BornOutsideAddressBirthDetails?.PresentInsideKeralaLocalityNameMlError ? false : false
  );

  const [PresentInsideKeralaStreetNameEnError, setPresentInsideKeralaStreetNameEnError] = useState(
    formData?.BornOutsideAddressBirthDetails?.PresentInsideKeralaStreetNameEnError ? false : false
  );
  const [PresentInsideKeralaStreetNameMlError, setPresentInsideKeralaStreetNameMlError] = useState(
    formData?.BornOutsideAddressBirthDetails?.PresentInsideKeralaStreetNameMlError ? false : false
  );

  const [PresentInsideKeralaPostOfficeError, setPresentInsideKeralaPostOfficeError] = useState(
    formData?.BornOutsideAddressBirthDetails?.PresentInsideKeralaPostOfficeError ? false : false
  );
  const [PresentInsideKeralaPincodeError, setPresentInsideKeralaPincodeError] = useState(
    formData?.BornOutsideAddressBirthDetails?.PresentInsideKeralaPincodeError ? false : false
  );
  ...
  const [PresentOutSideIndiaProvinceEnError, setPresentOutSideIndiaProvinceEnError] = useState(
    formData?.BornOutsideAddressBirthDetails?.PresentOutSideIndiaProvinceEnError ? false : false
  );
  const [PresentOutSideIndiaProvinceMlError, setPresentOutSideIndiaProvinceMlError] = useState(
    formData?.BornOutsideAddressBirthDetails?.PresentOutSideIndiaProvinceMlError ? false : false
  );
  const [PresentOutSideIndiaCityError, setPresentOutSideIndiaCityError] = useState(
    formData?.BornOutsideAddressBirthDetails?.PresentOutSideIndiaCityError ? false : false
  );
  const [PresentOutSideIndiaPostCodeError, setPresentOutSideIndiaPostCodeError] = useState(
    formData?.BornOutsideAddressBirthDetails?.PresentOutSideIndiaPostCodeError ? false : false
  );
  const [PresentOutSideIndiaLineOneEnError, setPresentOutSideIndiaLineOneEnError] = useState(
    formData?.BornOutsideAddressBirthDetails?.PresentOutSideIndiaLineOneEnError ? false : false
  );
  const [PresentOutSideIndiaLineOneMlError, setPresentOutSideIndiaLineOneMlError] = useState(
    formData?.BornOutsideAddressBirthDetails?.PresentOutSideIndiaLineOneMlError ? false : false
  );
  const [PresentOutSideIndiaLineTwoEnError, setPresentOutSideIndiaLineTwoEnError] = useState(
    formData?.BornOutsideAddressBirthDetails?.PresentOutSideIndiaLineTwoEnError ? false : false
  );
  const [PresentOutSideIndiaLineTwoMlError, setPresentOutSideIndiaLineTwoMlError] = useState(
    formData?.AddressBirBornOutsideAddressBirthDetailsthDetails?.PresentOutSideIndiaLineTwoMlError ? false : false
  );
          ...
          {countryValuePermanent === "IND" && valuePermanent === "KL" && (
            <div>
              <BornoutsidePermanentInsideKerala
                ...
                setTalukDropdownvalues={setTalukDropdownvalues}
                VillageDropdownvalues={VillageDropdownvalues}
                setVillageDropdownvalues={setVillageDropdownvalues}
