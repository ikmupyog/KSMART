...
const CreateStillBirthRegistration = ({ parentUrl,isEditStillBirth }) => {
  ...
  const [params, setParams, clearParams] = isEditStillBirth ? Digit.Hooks.useSessionStorage("CR_EDIT_STILL_BIRTH_REG", {}) : Digit.Hooks.useSessionStorage("CR_CREATE_STILL_BIRTH_REG", {});
  ...
  const onSuccess = () => {
    ...
    queryClient.invalidateQueries("CR_CREATE_STILL_BIRTH");
  };
  const handleSkip = () => {};
