...
const GroomAddressPermanentOutsideKerala = ({ config, onSelect, userType, formData, permntOutsideKeralaDistrict, setpermntOutsideKeralaDistrict,
  ...
  permntOutsideKeralaPostOfficeEn, setpermntoutsideKeralaPostOfficeEn, permntOutsideKeralaPostOfficeMl, setpermntoutsideKeralaPostOfficeMl,setpermntInKeralaAdrLBName,setpermntInKeralaAdrDistrict,
...
//isEditBirth ? isEditBirth : isEditDeath ? false :
  ...
  if (isEditBirth) {
    ...
    if (formData?.GroomAddressDetails?.permntOutsideKeralaDistrict != null) {
      if (cmbDistrict.length > 0 && (permntOutsideKeralaDistrict === undefined || permntOutsideKeralaDistrict === "")) {
        setpermntOutsideKeralaDistrict(cmbDistrict.filter(cmbDistrict => cmbDistrict.code === formData?.GroomAddressDetails?.permntOutsideKeralaDistrict)[0]);
      }
    }
    ...
    if (formData?.GroomAddressDetails?.permntOutsideKeralaVillage != null) {
      if (cmbUrbanRural.length > 0 && (permntOutsideKeralaVillage === undefined || permntOutsideKeralaVillage === "")) {
        setpermntOutsideKeralaVillage(cmbUrbanRural.filter(cmbUrbanRural => cmbUrbanRural.code === formData?.GroomAddressDetails?.permntOutsideKeralaVillage)[0]);
      }
    }
