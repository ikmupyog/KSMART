...
const AddressInsideKerala = ({ config, onSelect, userType, formData,WardNo, setWardNo,lbs, setLbs,insideKeralaDistrict, setinsideKeralaDistrict,
    insideKeralaLBTypeName, setinsideKeralaLBTypeName,insideKeralaLBName, setinsideKeralaLBName,insideKeralaTaluk, setinsideKeralaTaluk,
    insideKeralaPostOffice, setinsideKeralaPostOffice,insideKeralaPincode, setinsideKeralaPincode,insideKeralaHouseNameEn, setinsideKeralaHouseNameEn,
    insideKeralaHouseNameMl, setinsideKeralaHouseNameMl,insideKeralaLocalityNameEn, setinsideKeralaLocalityNameEn,
    insideKeralaLocalityNameMl, setinsideKeralaLocalityNameMl,insideKeralaStreetNameEn, setinsideKeralaStreetNameEn,
    insideKeralaStreetNameMl, setinsideKeralaStreetNameMl,insideKeralaVillage, setinsideKeralaVillage
