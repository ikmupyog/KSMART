...
const GroomAddressBasePage = ({
  ...
  //const [presentOutSideCountry, setOutSideCountry] = useState(formData?.GroomAddressDetails?.presentOutSideCountry ? formData?.GroomAddressDetails?.presentOutSideCountry : null);
  ...
  let countryPermcode = "";
  if (formData?.GroomAddressDetails?.permtaddressCountry === "COUNTRY_INDIA") {
    countryPermcode = "IND";
  } else {
    countryPermcode = formData?.GroomAddressDetails?.permtaddressCountry;
  }
  ...
  //const [permntOutsideIndiaCountry, setPermntOutsideIndiaCountry] = useState(formData?.GroomAddressDetails?.permntOutsideIndiaCountry ? formData?.GroomAddressDetails?.permntOutsideIndiaCountry : null);
