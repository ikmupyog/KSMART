...
const GeneralRemarks = ({ config, onSelect, userType, formData }) => {
  ...
  return (
    <React.Fragment>
      ...
      <div className="row">
            <div className="col-md-12" ><h1 className="headingh1" ><span style={{ background: "#fff", padding: "0 10px" }}>{`${t("CR_GENERAL_REMARKS")}`}</span> </h1>
            </div>
      </div>
      <div className="row">
            <div className="col-md-12" >
              <div className="col-md-6" ><CardLabel>{t("CR_GENERAL_REMARKS")}</CardLabel>
              <TextArea       
            t={t}
            isMandatory={false}
            type={"text"}
