    ...
    values: [
      {
        ...
        value:application?.InformationDeathAbandoned?.DateOfDeath?Digit.DateUtils.ConvertTimestampToDate(application?.InformationDeathAbandoned?.DateOfDeath, "dd/MM/yyyy") : t("CS_NA"),
      },
      { title: t("Gender"), value: application?.InformationDeathAbandoned?.DeceasedGender ? application?.InformationDeathAbandoned?.DeceasedGender?.code : t("CS_NA") },
      { title: t("CR_NATIONALITY"), value: application?.InformationDeathAbandoned?.Nationality ? application?.InformationDeathAbandoned?.Nationality : t("CS_NA") },
      { title: t("CS_COMMON_RELIGION"), value: application?.InformationDeathAbandoned?.Religion ? application?.InformationDeathAbandoned?.Religion : t("CS_NA") },
