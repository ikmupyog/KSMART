...
={}} = data;
    ...
    let AddressBirthDetails = {
        ...
        presentaddressCountry: _.get(DeathNACAddressPage, "presentaddressCountry.name", ""),
        presentaddressStateName: _.get(DeathNACAddressPage, "presentaddressStateName.name", ""),
        presentInsideKeralaLBName: _.get(DeathNACAddressPage, "presentInsideKeralaLBName.name", ""),
        presentInsideKeralaDistrict: _.get(DeathNACAddressPage, "presentInsideKeralaDistrict.name", ""),
        presentInsideKeralaTaluk: _.get(DeathNACAddressPage, "presentInsideKeralaTaluk.name", ""),
        presentInsideKeralaVillage: _.get(DeathNACAddressPage, "presentInsideKeralaVillage.name", ""),
        ...
        presentInsideKeralaPostOffice: _.get(DeathNACAddressPage, "presentInsideKeralaPostOffice.name", ""),
        presentInsideKeralaPincode: _.get(DeathNACAddressPage, "presentInsideKeralaPincode", ""),
        presentWardNo: _.get(DeathNACAddressPage, "presentWardNo.name", ""),
        ...
        permtaddressCountry: _.get(DeathNACAddressPage, "permtaddressCountry.name", ""),
        permtaddressStateName: _.get(DeathNACAddressPage, "permtaddressStateName.name", ""),
        permntInKeralaAdrLBName: _.get(DeathNACAddressPage, "permntInKeralaAdrLBName.name", ""),
        permntInKeralaAdrDistrict: _.get(DeathNACAddressPage, "permntInKeralaAdrDistrict.name", ""),
        permntInKeralaAdrTaluk: _.get(DeathNACAddressPage, "permntInKeralaAdrTaluk.name", ""),
        permntInKeralaAdrVillage: _.get(DeathNACAddressPage, "permntInKeralaAdrVillage.name", ""),
        ...
        permntInKeralaAdrPostOffice: _.get(DeathNACAddressPage, "permntInKeralaAdrPostOffice.name", ""),
        permntInKeralaAdrPincode: _.get(DeathNACAddressPage, "permntInKeralaAdrPincode", ""),
        permntInKeralaWardNo: _.get(DeathNACAddressPage, "permntInKeralaWardNo.name", ""),
