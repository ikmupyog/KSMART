...
const getAction = (flow) => {
  switch (flow) {
    case "STAKEHOLDER":
      ...
      break;
    default:
      actions = ["CR_MARRIAGE_REGISTRATION_DETAILS", "CR_GROOM_DETAILS", "CR_BRIDE_DETAILS", "CR_WITNESS_DETAILS", "CR_MARRIAGE_SUMMARY"];
  }
};
const Timeline = ({ currentStep = 1, flow = "" }) => {
  ...
  getAction(flow);
  return (
    <div className="timeline-container" style={isMobile ? {} : { maxWidth: "auto", minWidth: "auto", marginRight: "auto", marginTop: "20px" }}>
