  ...
  return (
    <React.Fragment>
      ...
      <div style={{ margin: "1rem" }}>
        <p style={{ fontSize: "20px", fontWeight: "700", color: "#00377B", marginBottom: "1rem" }}>Guidlines</p>
        <h2 style={{ marginBottom: "1rem", color: "#00377B", fontWeight: "600", fontSize: "18px" }}>{`${t(`CR_${fieldName}`)}`}</h2>
        <div style={{ margin: "1rem" }}>
