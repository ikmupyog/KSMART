    ...
    BirthDetails: [
      {
        ...
        birthStatistical: {
          ...
          duration_of_pregnancy_in_week: data?.StatisticalInfoDetails?.PregnancyDuration ? data?.StatisticalInfoDetails?.PregnancyDuration.code : null,
    ...
    deathCertificateDtls: [
      {
        ...
        ageUnit: data?.InformationDeath?.setAgeUnit,
        ...
        deathPlaceOfficerName: data?.PlaceOfDeathInstitution?.SiginedOfficer,
        deathPlaceOtherMl: data?.PlaceOfDeathOther?.PlaceOfDeathOtherDetailsMl,//data.PlaceOfDeathVehicle?.VehicleOtherDetailsMl
        deathPlaceOtherEn: data?.PlaceOfDeathOther?.PlaceOfDeathOtherDetailsEn,//data.PlaceOfDeathVehicle?.VehicleOtherDetailsEn
        ...
        femaleDependentMailId: data?.FamilyInformationDeath?.MotherEmail,
          ...
          deceasedIdproofType: data?.InformationDeath?.setIdCombo.code,
          deceasedIdproofNo: data?.InformationDeath?.IdNoNo,
          applicationType: "appl_new",
        ...
        statisticalInf: {
          ...
          religion: data?.InformationDeath?.setReligion.code,
          religionOther: null,
          ...
          deathMedicallyCertified: data?.StatisticalInfoContinue?.setDeathMedicallyCertified?.data?.StatisticalInfoContinue?.setDeathMedicallyCertified.code,
        ...
        addressInfo: {
          presentAddress: {
            id: null,
            deathDtlId: data?.AddressOfDecesed?.PresentDistrict.code,
            tenantId: data?.AddressOfDecesed?.PresentLBName.code,
            addrTypeId: "P",
            ...
            pincode: data?.AddressDetails?.PresentPincode,
            districtId: data?.AddressDetails?.PresentDistrict.code,
            stateId: data?.AddressDetails?.PresentStateName?.data?.AddressDetails?.PresentStateName.code,
            countryId: data?.AddressDetails?.PresentMotherCountry?.data?.AddressDetails?.PresentMotherCountry.code,
            talukNameEn: data?.AddressDetails?.PresentTaluk?.data?.AddressDetails?.PresentTaluk.name,
            talukNameMl: data?.AddressDetails?.PresentTaluk?.data?.AddressDetails?.PresentTaluk.namelocal,
            villageNameEn: data?.AddressDetails?.PresentVillage?.data?.AddressDetails?.PresentVillage.name,
            villageNameMl: data?.AddressDetails?.PresentVillage?.data?.AddressDetails?.PresentVillage.namelocal,
            postofficeNameEn: data?.AddressDetails?.PresentPostOffice?.data?.AddressDetails?.PresentPostOffice?.PresentPostOffice.name,
            postofficeNameMl: data?.AddressDetails?.PresentPostOffice?.data?.AddressDetails?.PresentPostOffice?.PresentPostOffice.namelocal,
          },
          permanentAddress: {
            id: null,
            deathDtlId: data?.AddressOfDecesed?.PermanentDistrict.code,
            tenantId: data?.AddressOfDecesed?.PermanentLBTypeName.code,
            addrTypeId: "R",
            houseNo: data?.AddressDetails?.PresentDistrict,
            residenceAsscno: data?.AddressDetails?.PermanentBuldingNo,
            streetNameEn:  data?.AddressDetails?.PermanentStreetNameEn,
            streetNameMl:  data?.AddressDetails?.PermanentStreetNameMl,
            ...
            districtId: data?.AddressDetails?.PermanentDistrict?.data?.AddressDetails?.PermanentDistrict.code,
            stateId: data?.AddressOfDecesed?.PermanentStateName.code,
            countryId: data?.AddressOfDecesed?.PermanentCountry.code,
            talukNameEn: data?.AddressDetails?.PermanentTaluk?.data?.AddressDetails?.PermanentTaluk.name,
            talukNameMl: data?.AddressDetails?.PermanentTaluk?.data?.AddressDetails?.PermanentTaluk.namelocal,
            villageNameEn: data?.AddressDetails?.PermanentVillage?.data?.AddressDetails?.PermanentVillage.name,
            villageNameMl: data?.AddressDetails?.PermanentVillage?.data?.AddressDetails?.PermanentVillage.namelocal,
            postofficeNameEn: data?.AddressDetails?.PermanentPostOffice?.data?.AddressDetails?.PermanentPostOffice.name,
            postofficeNameMl: data?.AddressDetails?.PermanentPostOffice?.data?.AddressDetails?.PermanentPostOffice.namelocal,
          },
          informantAddress: {
            id: "id",
          ...
          deathplaceAddress: {
            id: "id",
            deathDtlId: "death_dtl_id",
            tenantId: data?.PlaceOfDeathHome?.AdrsLBName.code,
            addrTypeId: "D",
          ...
          applicantAddress: {
            ...
            postofficeNameEn: "po_name_en",
            postofficeNameMl: "po_name_en",
            locationType: "localBurial",
            houeNameMl: "വീട്",
            houeNameEn: "HouseNameEng"
          },
          applicantDetails: {
            id: "id",
            tenantId: "tenantid",
            applicantName: "applicantName",
            applicantAadhar: "1122334455",
            applicantMobileNo: "123456789",
            applicantEmailId: "abc@gmail.com"
          }
        },
      },
    ],
