    ...
    ChildDetails: [
      {
        ...
        institutionNameCode: data?.ChildDetails?.institutionNameCode ? data?.ChildDetails?.institutionNameCode.code : null,
        ...
        AddressBirthDetails: {
          ...
          permntInKeralaAdrLBName: data?.AddressBirthDetails?.permntInKeralaAdrLBName ? data?.AddressBirthDetails?.permntInKeralaAdrLBName : null,
