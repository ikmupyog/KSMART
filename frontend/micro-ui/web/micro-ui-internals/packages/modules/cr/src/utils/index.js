    ...
    deathCertificateDtls: [
      {
        ...
        deathSignedOfficerMob: data?.HospitalDetails?.HospitalMobile,
        deathSignedOfficerAadhaar: data?.HospitalDetails?.HospitalAadhaar,
        deathPlaceWardId: "death_place_ward_id",
        isvehicle: data?.HospitalDetails?.setPlaceofDeath.code,
        vehicleHospitalMl : data?.PlaceOfDeathVehicle?.setAdmittedHospital.code,
        vehicleHospitalEn: "vehicle_hospital_en",
        vehicleFromplaceMl : data?.PlaceOfDeathVehicle?.VehicleFrom,
        vehicleFromplaceEn: "vehicle_fromplace_en",
        vehicleToPlaceMl  : data?.PlaceOfDeathVehicle?.VehicleTo,
        vehicleToPlaceEn: "vehicle_fromplace_en",
        vehicleNumber: null,
        vehicleDriverLicenceNo: data?.PlaceOfDeathVehicle?.VehicleRegistrationNo,
        informantAge: data?.PlaceOfDeathVehicle?.DriverAge,
        ...
        statisticalInfo: {
          ...
          deathDuringDelivery: data?.StatisticalInfoContinue?.setFemaleDeathPregnant.code,
          smokingNumYears: 111,
          tobaccoNumYears: 111,
        ...
        addressInfo: {
          presentAddress: {
            ...
            talukNameEn: data?.AddressDetails?.PresentTaluk,
            talukNameMl: null,
            villageNameEn: data?.AddressDetails?.PresentVillage,
            villageNameMl: null,
            postofficeNameEn: data?.AddressDetails?.PresentPostOffice,
