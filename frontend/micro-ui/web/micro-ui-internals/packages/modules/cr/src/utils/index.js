    ...
    deathCertificateDtls: [
      {
        ...
        deathPlaceType: data?.PlaceOfDeath?.setInstitution.data ? PlaceOfDeathInstitution?.setInstitution.code : null,
        deathPlaceInstId: data?.PlaceOfDeath?.setInstitutionId?.data?.PlaceOfDeathInstitution?.setInstitutionId.code,
