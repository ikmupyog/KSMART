    ...
    ChildDetails: [
      {
        ...
        AddressBirthDetails: {
          ...
          PermntOutsideIndiaCityTown: data?.AddressBirthDetails?.PermntOutsideIndiaCityTown ? data?.AddressBirthDetails?.PermntOutsideIndiaCityTown.code : null,
          PermanentOutsideIndiaPostCode: data?.AddressBirthDetails?.PermanentOutsideIndiaPostCode ? data?.AddressBirthDetails?.PermanentOutsideIndiaPostCode.code : null,
        },
