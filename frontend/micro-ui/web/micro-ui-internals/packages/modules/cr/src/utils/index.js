    ...
    BirthDetails: [
      {
        ChildDetails: {
          ...
          isChildName: data?.ChildDetails?.isChildName,
          ...
          hospitalCode: data?.ChildDetails?.hospitalName.code,
          birthPlace: data?.HospitalDetails?.birthPlace.code,
          hospitalName: data?.ChildDetails?.hospitalName.hospitalName,
          hospitalNameMl: data?.ChildDetails?.hospitalName.hospitalNamelocal,
          institutionTypeCode: data?.ChildDetails?.institution.code,
          institution: data?.ChildDetails?.institution.name,
          institutionNameCode: data?.ChildDetails?.institutionId.code,
          institutionId: data?.ChildDetails?.institutionId.institutionName,
          institutionIdMl: data?.ChildDetails?.institutionIdMl.institutionNamelocal,
          wardNo: data?.ChildDetails?.wardNo.code,
          wardNameEn: data?.ChildDetails?.wardNo.name,
          wardNameMl: data?.ChildDetails?.wardNo.localname,
          wardNumber: data?.ChildDetails?.wardNo.wardno,
          ...
          adrsPostOffice: data?.ChildDetails?.adrsPostOffice.code,
          adrsPincode: data?.ChildDetails?.adrsPincode.code,
          ...
          setadmittedHospitalEn: data?.ChildDetails?.setadmittedHospitalEn.code,
          vehicleDesDetailsEn: data?.ChildDetails?.vehicleDesDetailsEn.code,
          publicPlaceType: data?.ChildDetails?.publicPlaceType.code,
          ...
          pregnancyDuration: data?.ChildDetails?.pregnancyDuration.code,
          medicalAttensionSub: data?.ChildDetails?.medicalAttensionSub.code,
          deliveryMethods: data?.ChildDetails?.medicalAttensionSub.code,
        },
        ParentsDetails: {
          ...
          motherEducation: data?.ParentsDetails?.MotherEducation.code,
          motherProfession: data?.ParentsDetails?.MotherProfession.code,
          motherNationality: data?.ParentsDetails?.MotherNationality.code,
          ...
          fatherNationality: data?.ParentsDetails?.FatherNationality.code,
          fatherEducation: data?.ParentsDetails?.FatherEducation.code,
          fatherProfession: data?.ParentsDetails?.FatherProfession.code,
          Religion: data?.ParentsDetails?.Religion.code,
          fatherMobile: data?.ParentsDetails?.FatherMobile,
          FatherEmail: data?.ParentsDetails?.FatherEmail,
        },
        AddressBirthDetails: {
          presentaddressCountry: data?.AddressBirthDetails?.presentaddressCountry.code,
          presentaddressStateName: data?.AddressBirthDetails?.presentaddressStateName.code,
          presentInsideKeralaLBName: data?.AddressBirthDetails?.presentInsideKeralaLBName,
          presentInsideKeralaDistrict: data?.AddressBirthDetails?.presentInsideKeralaDistrict.code,
          presentInsideKeralaTaluk: data?.AddressBirthDetails?.presentInsideKeralaTaluk.code,
          presentInsideKeralaVillage: data?.AddressBirthDetails?.presentInsideKeralaVillage.code,
          ...
          presentInsideKeralaPincode: data?.AddressBirthDetails?.presentInsideKeralaPincode.code,
          presentInsideKeralaPostOffice: data?.AddressBirthDetails?.presentInsideKeralaPostOffice.code,
          presentWardNo: data?.AddressBirthDetails?.presentWardNo.code,
          presentOutsideKeralaDistrict: data?.AddressBirthDetails?.presentOutsideKeralaDistrict.code,
          presentOutsideKeralaTaluk: data?.AddressBirthDetails?.presentOutsideKeralaTaluk.code,
          presentOutsideKeralaVillage: data?.AddressBirthDetails?.presentOutsideKeralaVillage.code,
          presentOutsideKeralaCityVilgeEn: data?.AddressBirthDetails?.presentOutsideKeralaCityVilgeEn,
          presentOutsideKeralaPincode: data?.AddressBirthDetails?.presentOutsideKeralaPincode.code,
          ...
          presentOutSideCountry: data?.AddressBirthDetails?.presentOutSideCountry.code,
          presentOutSideIndiaadrsVillage: data?.AddressBirthDetails?.presentOutSideIndiaadrsVillage.code,
          ...
          permtaddressCountry: data?.AddressBirthDetails?.permtaddressCountry.code,
          permtaddressStateName: data?.AddressBirthDetails?.permtaddressStateName.code,
          permntInKeralaAdrLBName: data?.AddressBirthDetails?.permntInKeralaAdrLBName,
          permntInKeralaAdrDistrict: data?.AddressBirthDetails?.permntInKeralaAdrDistrict.code,
          permntInKeralaAdrTaluk: data?.AddressBirthDetails?.permntInKeralaAdrTaluk.code,
          permntInKeralaAdrVillage: data?.AddressBirthDetails?.permntInKeralaAdrVillage.code,
          ...
          permntInKeralaAdrPincode: data?.AddressBirthDetails?.permntInKeralaAdrPincode.code,
          permntInKeralaAdrPostOffice: data?.AddressBirthDetails?.permntInKeralaAdrPostOffice.code,
          permntInKeralaWardNo: data?.AddressBirthDetails?.permntInKeralaWardNo.code,
          permntOutsideKeralaDistrict: data?.AddressBirthDetails?.permntOutsideKeralaDistrict.code,
          permntOutsideKeralaTaluk: data?.AddressBirthDetails?.permntOutsideKeralaTaluk.code,
          permntOutsideKeralaVillage: data?.AddressBirthDetails?.permntOutsideKeralaVillage.code,
          ...
          PermntOutsideIndiaVillage: data?.AddressBirthDetails?.PermntOutsideIndiaVillage.code,
          PermntOutsideIndiaCityTown: data?.AddressBirthDetails?.PermntOutsideIndiaCityTown.code,
          PermanentOutsideIndiaPostCode: data?.AddressBirthDetails?.PermanentOutsideIndiaPostCode.code,
        },
    ...
    deathCertificateDtls: [
      {
        ...
        AddressBirthDetails: {
          ...
          presentaddressCountry: data?.AddressBirthDetails?.presentaddressCountry.code,
          presentaddressStateName: data?.AddressBirthDetails?.presentaddressStateName.code,
          presentInsideKeralaLBName: data?.AddressBirthDetails?.presentInsideKeralaLBName.code,
          presentInsideKeralaDistrict: data?.AddressBirthDetails?.presentInsideKeralaDistrict.code,
          presentInsideKeralaTaluk: data?.AddressBirthDetails?.presentInsideKeralaTaluk.code,
          presentInsideKeralaVillage: data?.AddressBirthDetails?.presentInsideKeralaVillage.code,
          presentInsideKeralaLocalityNameEn: data?.AddressBirthDetails?.presentInsideKeralaLocalityNameEn,
          ...
          presentOutsideKeralaTaluk: data?.AddressBirthDetails?.presentOutsideKeralaTaluk
            ? data?.AddressBirthDetails?.presentOutsideKeralaTaluk.code
            : null,
          ...
          permtaddressCountry: data?.AddressBirthDetails?.presentaddressCountry.code,
          permtaddressStateName: data?.AddressBirthDetails?.presentaddressStateName.code,
          permntInKeralaAdrLBName: data?.AddressBirthDetails?.permntInKeralaAdrLBName,
          permntInKeralaAdrDistrict: data?.AddressBirthDetails?.permntInKeralaAdrDistrict
            ...
            : null,
          permntInKeralaAdrTaluk: data?.AddressBirthDetails?.permntInKeralaAdrDistrict
          ...
          PermntOutsideIndiaCityTown: data?.AddressBirthDetails?.PermntOutsideIndiaCityTown
            ? data?.AddressBirthDetails?.PermntOutsideIndiaCityTown.code
            : null,
          PermanentOutsideIndiaPostCode: data?.AddressBirthDetails?.PermanentOutsideIndiaPostCode
            ? data?.AddressBirthDetails?.PermanentOutsideIndiaPostCode.code
            : null,
        },
