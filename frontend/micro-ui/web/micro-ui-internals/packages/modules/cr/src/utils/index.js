    ...
    deathCertificateDtls: [
      {
        ...
        addressInfo: {
          presentAddress: {
            ...
            addrTypeId: "P",
            houseNo: data?.AddressDetails?.PresentHouseNo,
            residenceAsscno: data?.AddressDetails?.PresentBuldingNo,
            streetNameEn: data?.AddressDetails?.PresentStreetEn,
            streetNameMl: data?.AddressDetails?.PresentStreetMl,
            ...
            districtId: data?.AddressDetails?.PresentDistrict,
            ...
            talukNameMl: data?.AddressDetails?.PresentTaluk?.data?.AddressDetails?.PresentTaluk.code,
            villageNameEn: data?.AddressDetails?.PresentVillage?.data?.AddressDetails?.PresentVillage.code,
            villageNameMl: data?.AddressDetails?.PresentVillage?.data?.AddressDetails?.PresentVillage.code,
            postofficeNameEn:data?.AddressDetails?.PresentPostOffice?.data?.AddressDetails?.PresentPostOffice?.PresentPostOffice.code,
            postofficeNameMl: data?.AddressDetails?.PresentPostOffice?.data?.AddressDetails?.PresentPostOffice?.PresentPostOffice.code,
          },
          permanentAddress: {
            id: null,
            deathDtlId: "death_dtl_id",
          ...
          deathplaceAddress: {
            ...
            pincode: data?.PlaceOfDeathHome?.PinCode,
            districtId: data?.PlaceOfDeathHome?.PresentDistrict?.data?.PlaceOfDeathHome?.setPostOffice.code,
            ...
            talukNameMl: data?.PlaceOfDeathHome?.setTaluk?.data?.PlaceOfDeathHome?.setTaluk.code,
            villageNameEn: data?.PlaceOfDeathHome?.setVillage.data?.PlaceOfDeathHome?.setVillage.code,
            villageNameMl: data?.PlaceOfDeathHome?.setVillage.data?.PlaceOfDeathHome?.setVillage.code,
            postofficeNameEn: data?.PlaceOfDeathHome?.setPostOffice.data?.PlaceOfDeathHome?.setPostOffice.code,
            postofficeNameMl: data?.PlaceOfDeathHome?.setPostOffice.data?.PlaceOfDeathHome?.setPostOffice.code,
          },
          burialAddress: {
            id: "id",
            deathDtlId: "death_dtl_id",
