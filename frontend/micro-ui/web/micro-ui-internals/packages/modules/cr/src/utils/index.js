    ...
    deathCertificateDtls: [
      {
        ...
        tenantId: tenantId,
        deathDateUnavailable: data?.InformationDeath?.checked ? data?.InformationDeath?.checked : 0,
        dateOfDeath: Date.parse(data?.InformationDeath?.DeathDate), //.Date.parse(data?.InformationDeath?.FromDate),
        timeOfDeath: data?.InformationDeath?.DeathTime ? data?.InformationDeath?.DeathTime : 0, //.data?.InformationDeath?.DeathTimeFrom,
        timeOfDeathUnit: "AM",
        dateOfDeath1: Date.parse(data?.InformationDeath?.ToDate) ?  Date.parse(data?.InformationDeath?.ToDate) : 0,
        timeOfDeath1: data?.InformationDeath?.DeathTimeTo ? data?.InformationDeath?.DeathTimeTo : 0,
        timeOfDeathUnit1: "am",
        deceasedUnIdentified: 0,
        ...
        deceasedAadharNumber: data?.InformationDeath?.AdharNo ? data?.InformationDeath?.AdharNo : 0 ,
        deceasedGender: data?.InformationDeath?.setGender?.data?.InformationDeath?.setGender.code,
        age: data?.InformationDeath?.Ageofbirth ? data?.InformationDeath?.Ageofbirth : 0,
        ageUnit: data?.InformationDeath?.setAgeUnit?.data?.InformationDeath?.setAgeUnit.code,
        dateOfBirth: Date.parse(data?.InformationDeath?.DateOfBirth) ? Date.parse(data?.InformationDeath?.DateOfBirth) : 0 ,
        ...
        deathPlaceOfficerName: data?.PlaceOfDeath?.SiginedOfficer ? data?.PlaceOfDeath?.SiginedOfficer : null`  ` ,
        deathPlaceOtherMl: data?.PlaceOfDeath?.PlaceOfDeathOtherDetailsMl ? data?.PlaceOfDeath?.PlaceOfDeathOtherDetailsMl : null, //data.PlaceOfDeathVehicle?.VehicleOtherDetailsMl
        ...
        informantNameEn: data?.PlaceOfDeath?.InformentNameEn ? data?.PlaceOfDeath?.InformentNameEn : null ,
        informantnameMl: data?.PlaceOfDeath?.InformentNameMl ? data?.PlaceOfDeath?.InformentNameMl : null,
        informantAadharSubmitted: data?.PlaceOfDeath?.isChecked ? data?.PlaceOfDeath?.isChecked : 0,
        informantAadharNo: data?.PlaceOfDeath?.AadhaarNo ? data?.PlaceOfDeath?.AadhaarNo : 0,
        informantMobileNo: data?.InformentAddress?.InformentMobileNo ? data?.InformentAddress?.InformentMobileNo : 0,
        ...
        maleDependentUnavailable: 0,
        maleDependentType: data?.FamilyInformationDeath?.setmaleDependent ? data?.FamilyInformationDeath?.setmaleDependent.code : 0,
        maleDependentTitle: "",
        maleDependentNameEn: data?.FamilyInformationDeath?.FatherOrHusbandNameEN ? data?.FamilyInformationDeath?.FatherOrHusbandNameEN : null,
        maleDependentNameMl: data?.FamilyInformationDeath?.FatherOrHusbandNameMl ? data?.FamilyInformationDeath?.FatherOrHusbandNameMl : null ,
        maleDependentAadharNo: data?.FamilyInformationDeath?.FatherOrHusbandAdharNo ? data?.FamilyInformationDeath?.FatherOrHusbandAdharNo : null,
        maleDependentMobileNo: data?.FamilyInformationDeath?.FatherMobile ? data?.FamilyInformationDeath?.FatherMobile : null,
        maleDependentMailId: data?.FamilyInformationDeath?.FatherEmail ? data?.FamilyInformationDeath?.FatherEmail : "",
        femaleDependentUnavailable: 0,
        femaleDependentTitle: "",
        femaleDependentNameEn: data?.FamilyInformationDeath?.MotherNameEn ? data?.FamilyInformationDeath?.MotherNameEn : "",
        femaleDependentNameMl: data?.FamilyInformationDeath?.MotherNameMl ? data?.FamilyInformationDeath?.MotherNameMl : "",
        femaleDependentAadharNo: data?.FamilyInformationDeath?.MotherAdharNo ? data?.FamilyInformationDeath?.MotherAdharNo :"",
        femaleDependentMobileNo: data?.FamilyInformationDeath?.MotherMobile ? data?.FamilyInformationDeath?.MotherMobile : "",
        femaleDependentMailId: data?.FamilyInformationDeath?.MotherEmail ? data?.FamilyInformationDeath?.MotherEmail :" ",
        isvehicle: 0,
        ...
        spouseUnavailable:0,        
        spouseType:"HUSBAND",
        spouseNameEn:"Velappan",
        spouseNameML:"വേലപ്പൻ",
        spouseEmailid:"devaki@gmail.com",
        spouseAadhaar:"124562124512",
        spouseMobileno:"5654789545",
        funcionUID: "CRDRNR",
        ...
        statisticalInfo: {
          ...
          deathDtlId: null,
          tenantId: tenantId,
          residenceLocalBody: data?.StatisticalInfo?.setLBType?.data?.StatisticalInfo?.setLBType.code,
          residencePlaceType: data?.StatisticalInfo?.setPlaceType?.data?.StatisticalInfo?.setPlaceType.code,
          residenceDistrict: data?.StatisticalInfo?.setDistrict?.data?.StatisticalInfo?.setDistrict.code,
          residenceState: data?.StatisticalInfo?.setStateName?.data?.StatisticalInfo?.setStateName.code,
          ...
          deathDuringDelivery: data?.StatisticalInfoContinue?.isPregnent?data?.StatisticalInfoContinue?.isPregnent : 0,
          smokingNumYears: data?.StatisticalInfoContinue?.textSmoke ? data?.StatisticalInfoContinue?.textSmoke : "",
          tobaccoNumYears: data?.StatisticalInfoContinue?.textTabacco ? data?.StatisticalInfoContinue?.textTabacco : "",
          arecanutNumYears: data?.StatisticalInfoContinue?.textPanMasala ? data?.StatisticalInfoContinue?.textPanMasala : "",
          alcoholNumYears: data?.StatisticalInfoContinue?.text ? data?.StatisticalInfoContinue?.text : "",
          nationality: data?.StatisticalInfo?.setCountry ? data?.StatisticalInfo?.setCountry?.code : null,
          // isSmoking: data?.StatisticalInfoContinue?.isPregnent ? data?.StatisticalInfoContinue?.isPregnent : 0,
          // isTobaccog: data?.StatisticalInfoContinue?.isTabacco ? data?.StatisticalInfoContinue?.isTabacco : 0,
          // isArecanut: data?.StatisticalInfoContinue?.isPanMasala ? data?.StatisticalInfoContinue?.isPanMasala : 0,
          // isAlcohol: data?.StatisticalInfoContinue?.isalcohol ? data?.StatisticalInfoContinue?.isalcohol : 0,
          smokingType: data?.StatisticalInfoContinue?.isPregnent ? data?.StatisticalInfoContinue?.isPregnent : 0,
          tobaccoType: data?.StatisticalInfoContinue?.isTabacco ? data?.StatisticalInfoContinue?.isTabacco : 0,
          arecanutType: data?.StatisticalInfoContinue?.isPanMasala ? data?.StatisticalInfoContinue?.isPanMasala : 0,
          alcoholType: data?.StatisticalInfoContinue?.isalcohol ? data?.StatisticalInfoContinue?.isalcohol : 0,
        ...
        addressInfo: {
          presentAddress: {
            ...
            tenantId: tenantId,
            addrTypeId: null,
            houseNo: data?.AddressOfDecesed?.PresentDoorNo ? data?.AddressOfDecesed?.PresentDoorNo : "",
            residenceAsscno: data?.AddressOfDecesed?.PresentResNo ? data?.AddressOfDecesed?.PresentResNo : "",
            streetNameEn: data?.AddressOfDecesed?.PresentStreetNameEn ? data?.AddressOfDecesed?.PresentStreetNameEn : "",
            streetNameMl: data?.AddressOfDecesed?.PresentStreetNameMl ? data?.AddressOfDecesed?.PresentStreetNameMl : "",
            localityEn: data?.AddressOfDecesed?.PresentLocalityNameEn ? data?.AddressOfDecesed?.PresentLocalityNameEn : "",
            localityMl: data?.AddressOfDecesed?.PresentLocalityNameMl ? data?.AddressOfDecesed?.PresentLocalityNameMl : "",
            cityEn: data?.AddressOfDecesed?.PresentCityEn ? data?.AddressOfDecesed?.PresentCityEn : "",
            cityMl: data?.AddressOfDecesed?.PresentCityMl ? data?.AddressOfDecesed?.PresentCityMl : "",
            // wardId: data?.AddressDetails?.PresentWard?.data?.AddressDetails?.PresentWard.code,
            talukId: data?.AddressOfDecesed?.PresentTaluk ? data?.AddressOfDecesed?.PresentTaluk.code : null,
            villageId: data?.AddressOfDecesed?.PresentVillage ? data?.AddressOfDecesed?.PresentVillage.code : "",
            postofficeId: data?.AddressOfDecesed?.PresentPostOffice ? data?.AddressOfDecesed?.PresentPostOffice.code : null,
            pincode: data?.AddressOfDecesed?.PresentPincode ? data?.AddressOfDecesed?.PresentPincode : 0,
            districtId: data?.AddressOfDecesed?.PresentDistrict ? data?.AddressOfDecesed?.PresentDistrict.code : null,
            stateId: data?.AddressOfDecesed?.PresentStateName ? data?.AddressOfDecesed?.PresentStateName.code : null,
            countryId: data?.AddressOfDecesed?.PresentCountry ? data?.AddressOfDecesed?.PresentCountry.code : null,
            talukNameEn: data?.AddressOfDecesed?.PresentTaluk ? data?.AddressOfDecesed?.PresentTaluk.name : null,
            talukNameMl: data?.AddressOfDecesed?.PresentTaluk ? data?.AddressOfDecesed?.PresentTaluk.localname : null,
            villageNameEn: data?.AddressOfDecesed?.PresentVillage ? data?.AddressOfDecesed?.PresentVillage.name : null,
            villageNameMl: data?.AddressOfDecesed?.PresentVillage ? data?.AddressOfDecesed?.PresentVillage.namelocal : null,
            postofficeNameEn: data?.AddressOfDecesed?.PresentPostOffice ? data?.AddressOfDecesed?.PresentPostOffice.name : null,
            postofficeNameMl: data?.AddressOfDecesed?.PresentPostOffice.namelocal ? data?.AddressOfDecesed?.PresentPostOffice.namelocal : null,
          },
          permanentAddress: {
            id: null,
            deathDtlId: null,
            ...
            talukId: data?.AddressOfDecesed?.PermanentTaluk ? data?.AddressOfDecesed?.PermanentTaluk.code : null,
            villageId: data?.AddressOfDecesed?.PermanentVillage ? data?.AddressOfDecesed?.PermanentVillage.code : null,
            postofficeId: data?.AddressOfDecesed?.PermanentPostOffice ? data?.AddressOfDecesed?.PermanentPostOffice.code : null,
            pincode: data?.AddressOfDecesed?.PermanentPincode ? data?.AddressOfDecesed?.PermanentPincode : 0,
            districtId: data?.AddressOfDecesed?.PermanentDistrict ? data?.AddressOfDecesed?.PermanentDistrict.code : null,
            ...
            talukNameEn: data?.AddressOfDecesed?.PermanentTaluk ? data?.AddressOfDecesed?.PermanentTaluk.name : null,
            talukNameMl: data?.AddressOfDecesed?.PermanentTaluk ? data?.AddressOfDecesed?.PermanentTaluk.namelocal : null,
            villageNameEn: data?.AddressOfDecesed?.PermanentVillage ? data?.AddressOfDecesed?.PermanentVillage.name : null,
            villageNameMl: data?.AddressOfDecesed?.PermanentVillage ? data?.AddressOfDecesed?.PermanentVillage.namelocal : null,
            postofficeNameEn: data?.AddressOfDecesed?.PermanentPostOffice ? data?.AddressOfDecesed?.PermanentPostOffice.name : null,
            postofficeNameMl: data?.AddressOfDecesed?.PermanentPostOffice ? data?.AddressOfDecesed?.PermanentPostOffice.namelocal : null,
          },
          informantAddress: {
            id: null,
            deathDtlId: null,
            tenantId: tenantId,
            addrTypeId: "",
            houseNo: data?.PlaceOfDeath?.InformantAdrsDoorNo ? data?.PlaceOfDeath?.InformantAdrsDoorNo : "",
            residenceAsscno: data?.PlaceOfDeath?.InformantAdrsResNo ? data?.PlaceOfDeath?.InformantAdrsResNo : "",
            streetNameEn: data?.PlaceOfDeath?.InformantAdrsStreetNameEn ? data?.PlaceOfDeath?.InformantAdrsStreetNameEn : "",
            streetNameMl: null,
            localityEn: data?.PlaceOfDeath?.InformantAdrsLocalityNameEn ? data?.PlaceOfDeath?.InformantAdrsLocalityNameEn : "",
            localityMl: null,
            cityEn: null,
            cityMl: null,
            wardId: null,
            talukId: data?.PlaceOfDeath?.InformantAdrsTaluk ? data?.PlaceOfDeath?.InformantAdrsTaluk.code : null,
            villageId: data?.PlaceOfDeath?.InformantAdrsVillage ? data?.PlaceOfDeath?.InformantAdrsVillage.code : null,
            postofficeId: data?.PlaceOfDeath?.InformantAdrsPostOffice ? data?.PlaceOfDeath?.InformantAdrsPostOffice.code : null,
            pincode: data?.PlaceOfDeath?.InformantAdrsPincode ? data?.PlaceOfDeath?.InformantAdrsPincode : 0,
            districtId: data?.PlaceOfDeath?.InformantAdrsDistrict ? data?.PlaceOfDeath?.InformantAdrsDistrict.code : null,
            stateId: data?.PlaceOfDeath?.InformantAdrsStateName ? data?.PlaceOfDeath?.InformantAdrsStateName.code : null,
            countryId: data?.PlaceOfDeath?.InformantAdrsCountry ? data?.PlaceOfDeath?.InformantAdrsCountry.name : null,
            talukNameEn: data?.PlaceOfDeath?.InformantAdrsTaluk ? data?.PlaceOfDeath?.InformantAdrsTaluk.name : null,
            talukNameMl: data?.PlaceOfDeath?.InformantAdrsTaluk ? data?.PlaceOfDeath?.InformantAdrsTaluk.namelocal : null,
            villageNameEn: data?.PlaceOfDeath?.InformantAdrsVillage ? data?.PlaceOfDeath?.InformantAdrsVillage.name : null,
            villageNameMl: data?.PlaceOfDeath?.InformantAdrsVillage ? data?.PlaceOfDeath?.InformantAdrsVillage.namelocal : null,
            postofficeNameEn: data?.PlaceOfDeath?.InformantAdrsPostOffice ? data?.PlaceOfDeath?.InformantAdrsPostOffice.name : null,
            postofficeNameMl: data?.PlaceOfDeath?.InformantAdrsPostOffice ? data?.PlaceOfDeath?.InformantAdrsPostOffice.namelocal : null,
          },
          deathplaceAddress: {
            id: null,
            deathDtlId: null,
          ...
          applicantAddress: {
            ...
            streetNameMl: null,
            localityEn: data?.ApplicantDetails?.InformantAdrsLocalityNameEn ? data?.ApplicantDetails?.InformantAdrsLocalityNameEn : "",
            localityMl: null,
            cityEn: null,
            cityMl: null,
            wardId: null,
            talukId: data?.ApplicantDetails?.InformantAdrsTaluk ? data?.ApplicantDetails?.InformantAdrsTaluk.code : null,
            villageId: data?.ApplicantDetails?.InformantAdrsVillage ? data?.ApplicantDetails?.InformantAdrsVillage.code : null,
            postofficeId: data?.ApplicantDetails?.InformantAdrsPostOffice ? data?.ApplicantDetails?.InformantAdrsPostOffice.code : null,
            pincode: data?.ApplicantDetails?.InformantAdrsPincode ? data?.ApplicantDetails?.InformantAdrsPincode : 0,
            districtId: data?.ApplicantDetails?.InformantAdrsDistrict ? data?.ApplicantDetails?.InformantAdrsDistrict.code : null,
            stateId: data?.ApplicantDetails?.InformantAdrsStateName ? data?.ApplicantDetails?.InformantAdrsStateName.code : null,
            countryId: data?.ApplicantDetails?.InformantAdrsCountry ? data?.ApplicantDetails?.InformantAdrsCountry.code : null,
            talukNameEn: data?.ApplicantDetails?.InformantAdrsTaluk ? data?.ApplicantDetails?.InformantAdrsTaluk.name : null,
            talukNameMl: data?.ApplicantDetails?.InformantAdrsTaluk ? data?.ApplicantDetails?.InformantAdrsTaluk.namelocal : null,
            villageNameEn: data?.ApplicantDetails?.InformantAdrsVillage ? data?.ApplicantDetails?.InformantAdrsVillage.name : null,
            villageNameMl: data?.ApplicantDetails?.InformantAdrsVillage ? data?.ApplicantDetails?.InformantAdrsVillage.namelocal : null,
            postofficeNameEn: data?.ApplicantDetails?.InformantAdrsPostOffice ? data?.ApplicantDetails?.InformantAdrsPostOffice.name : null,
            postofficeNameMl: data?.ApplicantDetails?.InformantAdrsPostOffice ? data?.ApplicantDetails?.InformantAdrsPostOffice.namelocal : null,
            locationType: null,
            houeNameMl: null,
            houeNameEn: data?.ApplicantDetails?.InformantAdrsHouseNameEn ? data?.ApplicantDetails?.InformantAdrsHouseNameEn : "",
          },
        },
        applicantDetails: {
          id: null,
          tenantId: tenantId,
          applicantName: data?.ApplicantDetails?.ApplicantNameEn ? data?.ApplicantDetails?.ApplicantNameEn : "",
          applicantAadhar: data?.ApplicantDetails?.AadhaarNo ? data?.ApplicantDetails?.AadhaarNo : "",
          applicantMobileNo: data?.ApplicantDetails?.InformentMobileNo ? data?.ApplicantDetails?.InformentMobileNo : "",
          applicantEmailId: data?.ApplicantDetails?.InformentEmail ? data?.ApplicantDetails?.InformentEmail : "",
