...
const DraftTemplate = ({ path, handleNext, formData, config, onSelect }) => {
                ...
                <div className="FileFlowWrapper" style={{ height: "1000px" }}>
                    ...
                    <div className="row" >
                        ...
                        <div className="col-md-12" >
                            ...
                            <h1 style={{ textAlign: "center", margin: "auto", fontSize: "25px", marginTop: "50px", textDecoration: "underline" }} >{t("NOTICE")}</h1>
