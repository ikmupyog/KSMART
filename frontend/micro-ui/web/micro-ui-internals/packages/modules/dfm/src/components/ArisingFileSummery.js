    ...
    return (
        <React.Fragment>
            ...
            <FormStep config={config} onSelect={goNext} isDisabled={!declaration}>
                <Card>
                    <Accordion expanded={true} title="CS_ADDCOMPLAINT_DETAILS"
                        content={<StatusTable >
                            <div className="row">
                            ...
                            <div className="row">
                                <div className="col-md-12">
                                    <div className="col-md-2">
                                        <CardText style={{ fontSize: "15px", Colour: "black", textAlign: "left" }}>CS_COMPLAINT_DETAILS_COMPLAINT_TYPE :</CardText>
                                    </div>
                                    <div className="col-md-3">
                                        {/* <CardText style={{ fontSize: "15px", Colour: "black", textAlign: "left" }}>{t(complaintType?.key)}</CardText> */}
                                        <CardText style={{ fontSize: "15px", Colour: "black", textAlign: "left" }}>complaintType</CardText>
                                    </div>
                                    <div className="col-md-2">
                                        <CardText style={{ fontSize: "15px", Colour: "black", textAlign: "left" }}>CS_ADDCOMPLAINT_COMPLAINT_SUBTYPE :</CardText>
                                    </div>
                                    <div className="col-md-3">
                                        <CardText style={{ fontSize: "15px", Colour: "black", textAlign: "left" }}>subType</CardText>
                                    </div>
                                </div>
                            </div>
                        </StatusTable>}
