...
const SubFunctionAdding = ({ path, handleNext, formData, config, onSelect }) => {
  ...
  const columns = useMemo(
    () => [
      ...
      {
        Header: t("SUB_FUNCTION_NAME_ENG"),
        Cell: ({ row }) => GetCell(t(row?.original?.view || "NA")),
        disableSortBy: true,
      },

      {
        Header: t("SUB_FUNCTION_NAME_MAL"),
        Cell: ({ row }) => GetCell(t(row?.original?.view || "NA")),
        disableSortBy: true,
      },
      {
          ...
          <div className="row wrapper-file">
            <div className="col-md-12 col-sm-12 col-xs-12">
              ...
              <div className="col-md-4 col-sm-12 col-xs-12">
                ...
                <Dropdown t={t} type={"text"} optionKey="i18nKey" name="RegistrationNo" placeholder={t("MAJOR_FUNCTION_NAME_ENG")} />
              </div>
              <div className="col-md-4 col-sm-12 col-xs-12">
                <CardLabel>
                  {t("SF_CODE")}
                ...
                <TextInput t={t} type={"text"} optionKey="i18nKey" name="RegistrationNo" placeholder={t("SF_CODE")} />
              </div>
              <div className="col-md-4 col-sm-12 col-xs-12">
                <CardLabel>
                ...
                <TextInput t={t} type={"text"} optionKey="i18nKey" name="RegistrationNo" placeholder={t("SUB_FUNCTION_NAME_ENG")} />
              </div>
              <div className="col-md-4 col-sm-12 col-xs-12">
                <CardLabel>
                ...
                <TextInput t={t} type={"text"} optionKey="i18nKey" name="RegistrationNo" placeholder={t("SUB_FUNCTION_NAME_MAL")} />
              </div>
            </div>
          </div>
      ...
      <div className="moduleLinkHomePageModuleLinks">
        <div className="FileFlowWrapper customSubFunctionTable">
          <Table
            ...
            //     return {
            //         style: {
            //             minWidth: cellInfo.column.Header === t("ES_INBOX_APPLICATION_NO") ? "10px" : "",
            //             padding: "2px 5px",
            //             fontSize: "16px",
            //         },
            //     };
