import {
  ...
  const DFMEmployeeApplicationDetails = ({ t, config, onSelect, value, userType, formData }) => {
              ...
              <div className="row">
                <div className="col-md-12">
                  <h1 className="headingh1">
                    <span style={{ background: "#fff", padding: "0 10px" }}>{`${t("DFM_APPLICATION_DETAILS_TEXT2")}`}</span>
                  </h1>
                </div>
              </div>
              <div className="row">
  ...
  export default DFMEmployeeApplicationDetails;
