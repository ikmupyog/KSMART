...
import { configDeathApproverApplication } from "../config";
...
const AbandonedActionModal = ({ t, action, tenantId, state, id, closeModal, submitAction, actionData, applicationData, businessService, moduleCode }) => {
  console.log(action + businessService);
...
export default AbandonedActionModal;
