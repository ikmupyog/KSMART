...
const KsmartHome = () => {
    ...
    return <React.Fragment>
        ...
        <div className="sulb-section-d">
            <div className="container">
                <div className="media-title-top wow animated fadeInUp">Smart ULB</div>
                <div className="row">
                ...
                <div className="row wow animated fadeInUp">
                    <a href="" className="ULB-show-btn">Show All</a>
                </div>
            </div>
        </div>
        ...
        <div className="k-smarrt-media-mainsec">
            <div className="container">
                <div className="media-title-top wow animated fadeInUp">Ksmart Media Center</div>
                <div className="row">
                    <div className="col-lg-1"></div>
                    <div className="col-lg-10">
                        <nav className="custom-navtabs-k wow animated fadeInUp">
                            <div className="nav nav-tabs" id="nav-tab" role="tablist">
                                <button className="nav-link active" id="nav-News-tab" data-bs-toggle="tab" data-bs-target="#nav-News"
                                    type="button" role="tab" aria-controls="nav-News" aria-selected="true">Latest News</button>
                                <button className="nav-link" id="nav-Events-tab" data-bs-toggle="tab" data-bs-target="#nav-Events"
                                    type="button" role="tab" aria-controls="nav-Events" aria-selected="false">Events</button>
                                <button className="nav-link" id="nav-Advertisments-tab" data-bs-toggle="tab"
                                ...
                                <button className="nav-link" id="nav-Photos-tab" data-bs-toggle="tab" data-bs-target="#nav-Photos"
                                    type="button" role="tab" aria-controls="nav-Photos" aria-selected="false">Photos</button>
                                <button className="nav-link" id="nav-Videos-tab" data-bs-toggle="tab" data-bs-target="#nav-Videos"
                                    type="button" role="tab" aria-controls="nav-Videos" aria-selected="false">Videos</button>
                                <button className="nav-link" id="nav-Initiatives-tab" data-bs-toggle="tab" data-bs-target="#nav-Initiatives"
                ...
                <div className="tab-content" id="nav-tabContent">
                    <div className="tab-pane fade show active" id="nav-News" role="tabpanel" aria-labelledby="nav-News-tab"
                        tabindex="0">
                        <div className="row">
                            <div className="col-lg-4 col-md-6 mb-3 mb-lg-0 wow animated fadeInUp">
                                <div className="media-box-view-cont">
                                    <img src="https://ulb-logos.s3.ap-south-1.amazonaws.com/media1.png" alt="" className="media-images" />
                                    <div className="member-layer-content">
                            ...
                            <div className="col-lg-4 col-md-6 mb-3 mb-lg-0 wow animated fadeInUp">
                                <div className="media-box-view-cont">
                                    <img src="https://ulb-logos.s3.ap-south-1.amazonaws.com/media2.png" alt="" className="media-images" />
                                    <div className="member-layer-content">
                                        <h6>Programmer and icon control the system in data center room</h6>
                                        <p><svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                            ...
                            <div className="col-lg-4 col-md-6 mb-3 mb-lg-0 wow animated fadeInUp">
                                <div className="media-box-view-cont">
                                    <img src="https://ulb-logos.s3.ap-south-1.amazonaws.com/media3.png" alt="" className="media-images" />
                                    <div className="member-layer-content">
                                        <h6>Programmer and icon control the system in data center room</h6>
                                        <p><svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                        ...
                        <div className="row">
                            <div className="col-12">
                                <a href="" className="more-media-btn wow animated fadeInUp">Show All News</a>
                            </div>
                        </div>
                    </div>
                    <div className="tab-pane fade" id="nav-Events" role="tabpanel" aria-labelledby="nav-Events-tab" tabindex="0">2</div>
                    <div className="tab-pane fade" id="nav-Advertisments" role="tabpanel" aria-labelledby="nav-Advertisments-tab"
                        tabindex="0">3</div>
                    <div className="tab-pane fade" id="nav-Photos" role="tabpanel" aria-labelledby="nav-Photos-tab" tabindex="0">4</div>
                    <div className="tab-pane fade" id="nav-Videos" role="tabpanel" aria-labelledby="nav-Videos-tab" tabindex="0">5</div>
                    <div className="tab-pane fade" id="nav-Initiatives" role="tabpanel" aria-labelledby="nav-Initiatives-tab"
                        tabindex="0">6</div>
                </div>
            </div>
        </div>
        ...
        <div className="section-download-ksm">
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-lg-4 col-md-12 mb-4 mb-lg-0 wow animated fadeInUp">
                        <div
                            className="app-download-icvd d-block d-lg-flex d-md-flex align-items-center gap-3 text-center text-lg-start text-md-start">
                            <div className="bg-app-icon bg-transparent">
        ...
        <footer className="footer-ksmart-bg">
            <div className="container">
                ...
                <div className="row">
                    <div className="col-lg-3 wow animated fadeInUp">
                        <div className="counter-call0main text-center">
                            <h4>Visitors Counter</h4>
                            <a href="">3,546,646</a>
                        </div>
                    </div>
                    <div className="col-lg-6 wow animated fadeInUp">
                        <div className="social-media-kt text-center">
                            <h4>Social Media & Programs</h4>
                            <ul>
                                <li><a href="" alt="" data-bs-custom-className="custom-tooltip" data-bs-toggle="tooltip"
                                    data-bs-placement="top" data-bs-title="Facebook"><img src="https://ulb-logos.s3.ap-south-1.amazonaws.com/social1.svg" alt="" /></a></li>
                                <li><a href="" data-bs-custom-className="custom-tooltip" data-bs-toggle="tooltip" data-bs-placement="top"
