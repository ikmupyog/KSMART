...
const MigrateApplication = ({ isRenewal }) => {
  ...
  let config = [];
  const [params, setParams, clearParams] =  Digit.Hooks.useSessionStorage("TL_MIGRATE_TRADE", {});
  ...
  config.indexRoute = isRenewal ? "licensemigrate-unit-det" : "license-unit-det";
...
export default MigrateApplication;
