...
const TLCorrectionDocumentUpload = ({ t, config, onSelect, formData,onEditSelect ,formDataEdit }) => {
  ...
  const [uploadedFile, setUploadedFile] = useState(formDataEdit?.TradeDetails?.tradeLicenseDetail?.applicationDocuments?.fileStoreId || null);
...
export default TLCorrectionDocumentUpload;
