                ...
                <div style={{
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-3">
                      ...
                      <TextInput t={t} isMandatory={config.isMandatory} type={"text"} name="applicantEmail" value={field.applicantEmail} onChange={e => handleAppInputField(index, e.target.value, "applicantEmail")} />
                    </div>
                    <div className="col-md-3">
