...
const EditTrade = ({ isRenewal }) => {
  ...
  const [params, setParams, clearParams] = isRenewal ? Digit.Hooks.useSessionStorage("TL_RENEWAL_TRADE", {}) : Digit.Hooks.useSessionStorage("TL_EDIT_TRADE", {});
  ...
  config.indexRoute = isRenewal ? "edit-application" : "edit-application";
