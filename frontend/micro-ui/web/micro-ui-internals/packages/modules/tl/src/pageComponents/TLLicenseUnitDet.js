...
const TLLicenseUnitDet = ({ t, config, onSelect, userType, formData }) => {
  ...
  const { data: dataitem = {}, isLoading1 } = Digit.Hooks.tl.useTradeLicenseMDMS(stateId, "TradeLicense", "TradeStructureSubtype");
            ...
            return (
              <div>
                <div style={{ borderRadius: "5px", borderColor: "#f3f3f3", background: "white", display: "flow-root", }} >
                  ...
                  <div className="row">   
                    <div className="col-md-2" >
                      ...
                      <Dropdown t={t} optionKey="name" isMandatory={true} option={cmbDistrict}  disabled={isEdit} placeholder={`${t("CS_COMMON_DISTRICT")}`} />
                    </div>
                    <div className="col-md-2" >
                    ...
                    <div className="col-md-3" >
                      ...
                      <Dropdown t={t} optionKey="name" isMandatory={false} option={lbs} disabled={isEdit} placeholder={`${t("CS_COMMON_LB_NAME")}`} />
                    </div>
                    <div className="col-md-2" >
                      <CardLabel>Zonal</CardLabel>
                      <Dropdown t={t} optionKey="namecmb" isMandatory={config.isMandatory} option={Zonal}   {...(validation = { isRequired: true, title: t("TL_INVALID_Zone") })} />
                    </div>
                    <div className="col-md-3" >
                      <CardLabel>Ward</CardLabel>
                      <Dropdown t={t} optionKey="namecmb" isMandatory={config.isMandatory} option={cmbWardNoFinal}   {...(validation = { isRequired: true, title: t("TL_INVALID_WARD_NO") })} />
                    </div>
                  </div>
                  <div className="row">
                  ...
                  <div className="row">    {/* {`${t("TL_NEW_TRADE_DETAILS_TRADE_CAT_LABEL")}`} */}
                    <div className="col-md-3" ><CardLabel>Bussiness Category<span className="mandatorycss">*</span></CardLabel>
                        <Dropdown t={t} option={TradeCategoryMenu} optionKey="i18nKey" name={`TradeCategory-${index}`}   placeholder="Bussiness Category" />
                    </div>
                    <div className="col-md-3" >{/* {`${t("TL_NEW_TRADE_DETAILS_TRADE_TYPE_LABEL")}`} */}
                       <CardLabel>Bussiness Type<span className="mandatorycss">*</span></CardLabel>
                        <Dropdown t={t} optionKey="i18nKey" isMandatory={config.isMandatory}  placeholder="Bussiness Type" />
                    </div>
                    <div className="col-md-3" > {/* {`${t("TL_NEW_TRADE_DETAILS_TRADE_SUBTYPE_LABEL")}`} */}                 
                      <CardLabel>Bussiness Sub Type <span className="mandatorycss">*</span></CardLabel>
                      <Dropdown t={t} optionKey="i18nKey" isMandatory={config.isMandatory} option={sortDropdownNames(getTradeSubTypeMenu(field?.tradetype), "i18nKey", t)} placeholder="Bussiness Sub Type" />
                    </div>
                    <div className="col-md-3">{/*{`${t("TL_CUSTOM_DETAILED_TYPE_LABEL")}`}*/}
                ...
                {/* {`${t("TL_LOCALIZATION_PLACE_ACTVITY")}`} */}
                  <div className="col-md-3" ><CardLabel>Place/Structure Type<span className="mandatorycss">*</span></CardLabel>
                  ...
                  <div className="col-md-3" ><CardLabel>Place/Structure Sub Type<span className="mandatorycss">*</span></CardLabel>
