          ...
          {fields.map((field, index) => {
            return (
              ...
              <div>
                ...
                <TextInput t={t} type={"text"} optionKey="i18nKey" name="CustomType"  />
                    </div>
                    <div className="col-md-2" >
                    <CardLabel>District</CardLabel>
                <TextInput t={t} type={"text"} optionKey="i18nKey" name="CustomType1"  />
                    </div>
                    <div className="col-md-3" >
                    <CardLabel>District</CardLabel>
                <TextInput t={t} type={"text"} optionKey="i18nKey" name="CustomType2"  />
                    </div>
                    <div className="col-md-2" >
                    <CardLabel>District</CardLabel>
                <TextInput t={t} type={"text"} optionKey="i18nKey" name="CustomType3"  />
                    </div>
                    <div className="col-md-3" >
                    <CardLabel>District</CardLabel>
                <TextInput t={t} type={"text"} optionKey="i18nKey" name="CustomType4"  />
                    </div>
                </div>
