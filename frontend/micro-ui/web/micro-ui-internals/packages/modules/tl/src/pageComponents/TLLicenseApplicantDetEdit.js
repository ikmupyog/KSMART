...
const TLLicenseApplicantDetEdit = ({ t, config, onSelect, userType, formData }) => {
  ...
  const goNext = async () => {
    ...
    console.log("form data"+JSON.stringify(formDatalocal));
...
export default TLLicenseApplicantDetEdit;