...
@Service
public class SideYardService_Amend02Oct20 extends GeneralRule {
    ...
    private void checkSideYardLessThanTenOrEqualToMts(final Plan pl, SetBack setBack, Building building,
        ...
        if (mostRestrictiveOccupancy.getType().getCode().equals(A1) ||
            ...
            if (plot.getArea().compareTo(SITEAREA_125) <= 0) {
                ...
                /*
                 * if (pl.getPlanInformation().getOpeningOnSideBelow2mtsDesc().equalsIgnoreCase(DcrConstants.NO) &&
                 * pl.getPlanInformation().getOpeningOnSideAbove2mtsDesc().equalsIgnoreCase(DcrConstants.NO) &&
                 ...
                 * (pl.getPlanInformation().getOpeningOnSideBelow2mtsDesc().equalsIgnoreCase(DcrConstants.NO) &&
                 * pl.getPlanInformation().getOpeningOnSideAbove2mtsDesc().equalsIgnoreCase(DcrConstants.NO) &&
                 * building.getFloorsAboveGround().compareTo(BigDecimal.valueOf(2)) > 0) { side2val = SIDEVALUE_FIFTY_CM; side1val
                 * = SIDEVALUE_ONE; side2Meanval = side2val; side1Meanval = side1val; } else if
                 * (pl.getPlanInformation().getOpeningOnRearAbove2mtsDesc().equalsIgnoreCase(DcrConstants.NO) &&
                 * pl.getPlanInformation().getOpeningOnSideBelow2mtsDesc().equalsIgnoreCase(DcrConstants.NO) &&
                 ...
                 * (pl.getPlanInformation().getOpeningOnSideBelow2mtsDesc().equalsIgnoreCase(DcrConstants.NO) &&
                 * pl.getPlanInformation().getOpeningOnSideAbove2mtsDesc().equalsIgnoreCase(DcrConstants.NO)) { side2val =
                 * SIDEVALUE_FIFTY_CM; side1val = SIDEVALUE_ONE; side2Meanval = side2val; side1Meanval = side1val; } else if
                 * (pl.getPlanInformation().getOpeningOnSideBelow2mtsDesc().equalsIgnoreCase(NO)) { side2val =
