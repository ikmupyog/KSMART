...
public class DistanceToRoad extends FeatureProcess {
    ...
    public Plan process(Plan pl) {
        ...
        if (amendmentRefNumber != null && (AMEND_NOV19.equals(amendmentRefNumber) || AMEND_OCT20.equals(amendmentRefNumber))) {
            distanceToRoad_Amend08Nov19.process(pl);
            pl.getFeatureAmendments().put("Common_Distance to Road", AMEND_DATE_081119.toString());
        }else
            {
            validate(pl);
                ...
                if (!Util.isSmallPlot(pl)) {
                    if (pl.getNotifiedRoads().get(0).getDistancesFromCenterToPlot() != null &&
                        ...
                        checkBuildingDistanceFromRoad(pl, exptectedDistance,
                                ...
                                NOTIFIED_SHORTESTDISTINCTTOROADFROMCENTER, SUB_RULE_25_1, SUB_RULE_25_1, NOTIFIED_SHORTESTDISTINCTTOROADFROMCENTER);//SUB_RULE_25_1_DESCRIPTION
                }
                if (pl.getNotifiedRoads().get(0).getShortestDistanceToRoad() != null && !pl.getNotifiedRoads().get(0).getShortestDistanceToRoad().isEmpty()) {
            ...
            if (pl.getNonNotifiedRoads() != null && !pl.getNonNotifiedRoads().isEmpty()) {
                ...
                if(!Util.isSmallPlot(pl)){  
                    if (pl.getNonNotifiedRoads().get(0).getDistancesFromCenterToPlot() != null &&
                        ...
                        checkBuildingDistanceFromRoad(pl, exptectedDistance,
                                ...
                                NONNOTIFIED_SHORTESTDISTINCTTOROADFROMCENTER, SUB_RULE_25_1, SUB_RULE_25_1, NONNOTIFIED_SHORTESTDISTINCTTOROADFROMCENTER);
                }
                if (pl.getNonNotifiedRoads().get(0).getShortestDistanceToRoad() != null &&
                     ...
                     if (Util.isSmallPlot(pl)) {                    
                        ...
                        checkBuildingDistanceFromRoad(pl, THREE,
                                pl.getNonNotifiedRoads().get(0).getShortestDistanceToRoad(),
                                NONNOTIFIED_SHORTESTDISTINCTTOROAD, SUB_RULE_25_1, SUB_RULE_25_1, NONNOTIFIED_ROAD+SUB_RULE_25_1_PROVISIO_DESC);
            ...
            if (pl.getCuldeSacRoads() != null && !pl.getCuldeSacRoads().isEmpty()) {
                ...
                if (pl.getCuldeSacRoads().get(0).getShortestDistanceToRoad() != null
                    ...
                    checkBuildingDistanceFromRoad(pl, exptectedDistance,pl.getCuldeSacRoads().get(0).getShortestDistanceToRoad(),
                            CULD_SAC_SHORTESTDISTINCTTOROAD, SUB_RULE_25_1_PROVISIO, SUB_RULE_25_1_PROVISIO, CULDESAC_ROAD+SUB_RULE_25_1_PROVISIO_DESC);
                    ...
                    if (!Util.isSmallPlot(pl)) { 
                        if (pl.getCuldeSacRoads().get(0).getDistancesFromCenterToPlot() != null &&
                            ...
                            checkBuildingDistanceFromRoad(pl, exptectedDistance,
                                    ...
                                    CULDESAC_SHORTESTDISTINCTTOROADFROMCENTER, SUB_RULE_25_1, SUB_RULE_25_1, CULDESAC_SHORTESTDISTINCTTOROADFROMCENTER);
                    }
                }
            }
            ...
            if (pl.getLaneRoads() != null && !pl.getLaneRoads().isEmpty()) {
                ...
                if (pl.getLaneRoads().get(0).getShortestDistanceToRoad() != null 
                    ...
                    checkBuildingDistanceFromRoad(pl, exptectedDistance,
                            ...
                            LANE_SHORTESTDISTINCTTOROAD, SUB_RULE_25_1_PROVISIO, SUB_RULE_25_1_PROVISIO, LANE_ROAD+SUB_RULE_25_1_PROVISIO_DESC);
                if (minimumHeightOfBuilding.compareTo(SEVEN) > 0) {
                    exptectedDistance = FIVE;
                    if (!Util.isSmallPlot(pl)) {
	...
	private void checkBuildingDistanceFromRoad(Plan pl, BigDecimal exptectedDistance,
		 ...
		 * 
		 * //Take minimum distance among road distance for (BigDecimal distance :
		 * roadDistances) { if(minimumDistance==null) minimumDistance=distance; else
		 * if(distance.compareTo(minimumDistance)<0) minimumDistance=distance; }
		 * 
