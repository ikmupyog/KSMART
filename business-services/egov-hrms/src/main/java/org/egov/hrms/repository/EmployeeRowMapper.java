...
public class EmployeeRowMapper implements ResultSetExtractor<List<Employee>> {
        ...
        try {
            ...
            if (!StringUtils.isEmpty(rs.getString("jurisdiction_uuid")) && (!ids.contains(rs.getString("jurisdiction_uuid")))) {
                ...
                Jurisdiction jurisdiction = Jurisdiction.builder().id(rs.getString("jurisdiction_uuid"))
						...
						.hospitalCode(rs.getString("hospital_code")).hospitalName(rs.getString("hospital_name"))
						.institutiontype(rs.getString("institution_type"))
    ...
    public void addChildrenToJurisdiction(ResultSet rs, Jurisdiction jurisdiction) {
        setJurisdictionChild(rs, jurisdiction);
    }

    public void setJurisdictionChild(ResultSet rs, Jurisdiction jurisdiction) {
