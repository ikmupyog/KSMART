...
public class EmployeeQueries {
	...
	public static final String HRMS_GET_EMPLOYEES = "SELECT employee.id as employee_id, employee.uuid as employee_uuid, employee.code as employee_code, "
			...
			+ "react.createddate as react_createddate, react.lastmodifiedby as react_lastmodifiedby, react.lastmodifieddate as react_lastmodifieddate,jurisdictionchild.wardcode,jurisdictionchild.zonecode ,"
