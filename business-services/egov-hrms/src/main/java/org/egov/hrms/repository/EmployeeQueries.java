...
public class EmployeeQueries {
	...
	public static final String HRMS_GET_EMPLOYEES = "SELECT employee.id as employee_id, employee.uuid as employee_uuid, employee.code as employee_code, "
			...
			+ "jurisdiction.hierarchy as jurisdiction_hierarchy, jurisdiction.boundarytype as jurisdiction_boundarytype, jurisdiction.boundary as jurisdiction_boundary,jurisdiction.rolecode as jurisdiction_role,jurisdiction.zonecode as jurisdiction_zone,"
			+ "jurisdiction.hospitalcode as hospital_code,jurisdiction.hospitalname as hospital_name,jurisdiction.institutiontype as institution_type, "
