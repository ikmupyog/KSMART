...
@Component
public class DeathApplnPaymentRowMapper  implements ResultSetExtractor<List<DeathDtl>>, BaseRowMapper{
     ...
     @Autowired
     DeathApplnPaymentRowMapper(DeathStatisticalRowMapper statisticalRowMapper , 
