...
public class DeathRegistryCorrectionDtls {
    
    @JsonProperty("InformationDeathCorrection")
    private DeathRegistryCorrectionBasicInfo deathCorrectionBasicInfo;

   @JsonProperty("AddressBirthDetails")
   private DeathRegistryAddressInfo deathCorrAddressInfo;    
