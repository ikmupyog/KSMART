...
@Component
@Slf4j
public class RegistryIDGenerator {
    ...
    @Autowired
    public RegistryIDGenerator(DeathConfiguration config, ServiceRequestRepository serviceRequestRepository,
     ...
     */
    public String setIDGenerator(DeathRegistryRequest request, String moduleCode, String idType) {
        ...
        Long ackNoId = null;
          ...
          //  System.out.println("ackNo"+ackNoDetails);
             idGenerated = idType + "-" + nextID
                ...
                + idgenCode + "-" + DeathRegistryConstants.STATE_CODE.toString();
             return idGenerated;
    }
    ...
    public Object mDMSCallForTenant(RequestInfo requestInfo, String tenantId) {
        ...
        masterDetails.add(MasterDetail.builder().name(DeathRegistryConstants.TENANTS)
