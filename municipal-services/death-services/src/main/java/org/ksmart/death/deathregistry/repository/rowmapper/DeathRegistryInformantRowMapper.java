...
@Component
public class DeathRegistryInformantRowMapper {

    public DeathRegistryInformantDtls extractData(ResultSet rs) throws SQLException, DataAccessException { 

        return DeathRegistryInformantDtls.builder()
                          ...
                          //  .initiatorMobile(rs.getString(""))
                           ...
                           // .informantAddrLbType(rs.getString(""))
                            ...
                            .informantAddrPincode(rs.getLong("I_pincode"))
