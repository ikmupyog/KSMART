...
public class DeathAddressRowMapper  implements ResultSetExtractor  , BaseRowMapper{
      ...
      public DeathAddressInfo extractData(ResultSet rs) throws SQLException, DataAccessException { // STATISTICAL
        return DeathAddressInfo.builder()
                           // .presentAddrId(rs.getString("addr_typeid"))
                          ...
                          //  .presentAddrLocationType(rs.getString(""))
                          ...
                          //  .presentAddrLbType(rs.getString(""))
                          ...
                          //  .permanentAddrId(rs.getString("streetname_ml"))
                            .permanentAddrTenantId(rs.getString("R_tenantid"))
                            .permanentAddrAddrTypeId(rs.getString("R_addr_typeid"))
                           // .permanentAddrLocationType(rs.getString(""))
                          ...
                          //  .permanentAddrLbType(rs.getString(""))
                            ...
                            //.permanentAddrPostalCode(rs.getString(""))
                            .build();
    }
