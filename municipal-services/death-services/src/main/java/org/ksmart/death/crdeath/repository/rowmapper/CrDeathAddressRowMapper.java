...
import org.ksmart.death.crdeath.web.models.CrDeathAddressInfo;/**
     ...
     * 
     */
interface CrDeathAddressRowMapper {

    default CrDeathAddress buildAddress(ResultSet rs, String prefix) throws SQLException {
        return CrDeathAddress.builder()
    ...
    default CrDeathAddressInfo getCrDeathAddressInfo(ResultSet rs) throws SQLException {
