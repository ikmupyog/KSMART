...
@Component
public class DeathRegistryCorrectionRowMapper   implements ResultSetExtractor<List<DeathRegistryCorrectionDtls>>, BaseRowMapper {
   
 
    @Override
    public List<DeathRegistryCorrectionDtls> extractData(ResultSet rs) throws SQLException, DataAccessException { 

        List<DeathRegistryCorrectionDtls> result = new ArrayList<>();
       // System.out.println("result"+result);
        while (rs.next()) {
   
            result.add(DeathRegistryCorrectionDtls.builder()
            ...
            .deathCorrectionBasicInfo(DeathRegistryCorrectionBasicInfo.builder()
            .id(rs.getString("id"))
