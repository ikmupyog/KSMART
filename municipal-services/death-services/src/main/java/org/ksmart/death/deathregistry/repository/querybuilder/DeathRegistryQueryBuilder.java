...
StringBuilder orderBy = new StringBuilder();
                        ...
                        addLikeFilter("LOWER(dt.deceased_firstname_en)", criteria.getDeceasedFirstNameEn().toLowerCase(), query, preparedStmtValues);
...
StringBuilder orderBy = new StringBuilder();
                        ...
                        addLikeFilter("LOWER(deceased_firstname_en)", criteria.getDeceasedFirstNameEn().toLowerCase(), query, preparedStmtValues); 
