...
public class DeathMdmsUtil {
   ...
   //RAkhi S ikm on 08.02.2023
    ...
    private List<String> getHospitalCode(Object mdmsData) {
        return JsonPath.read(mdmsData, DeathConstants.CR_MDMS_HOSPITALS_CODE_JSONPATH);
    }
    private List<String> getInstitutionCode(Object mdmsData) {
        return JsonPath.read(mdmsData, DeathConstants.CR_MDMS_INSTITUTIONS_CODE_JSONPATH);
    }
    private List<String> getInstitutionTypeCode(Object mdmsData) {
        return JsonPath.read(mdmsData, DeathConstants.CR_MDMS_INST_TYPE_CODE_JSONPATH);
    }
    ...
    public String getHospitalNameEn(Object mdmsData, String hospitalId) {
        ...
        return JsonPath.read(mdmsData, DeathConstants.CR_MDMS_HOSPITALS_CODES_JSONPATH+"["+index+"].hospitalName");
    }
    public String getHospitalNameMl(Object mdmsData, String hospitalId) {
        List<String> hospitals  = getHospitalCode(mdmsData);
        int index = hospitals.indexOf(hospitalId);
        return JsonPath.read(mdmsData, DeathConstants.CR_MDMS_HOSPITALS_CODES_JSONPATH+"["+index+"].hospitalNamelocal");
    }
    public String getHospitalAddressEn(Object mdmsData, String HospitalId) {
        List<String> hospitals  = getHospitalCode(mdmsData);
        int index = hospitals.indexOf(HospitalId);
        return JsonPath.read(mdmsData, DeathConstants.CR_MDMS_HOSPITALS_CODES_JSONPATH+"["+index+"].mainPlace");
    }
    public String getHospitalAddressMl(Object mdmsData, String hospitalId) {
        ...
        return JsonPath.read(mdmsData, DeathConstants.CR_MDMS_HOSPITALS_CODES_JSONPATH+"["+index+"].mainPlaceLocal");
    }
    public String getInstitutionNameEn(Object mdmsData, String institutionId) {
        ...
        return JsonPath.read(mdmsData, DeathConstants.CR_MDMS_INSTITUTIONS_CODES_JSONPATH+"["+index+"].institutionName");
    }

    public String getInstitutionNameMl(Object mdmsData, String institutionId) {
        List<String> tenants  = getInstitutionCode(mdmsData);
        int index = tenants.indexOf(institutionId);
        return JsonPath.read(mdmsData, DeathConstants.CR_MDMS_INSTITUTIONS_CODES_JSONPATH+"["+index+"].institutionNamelocal");
    }
    ...
    public String getInstitutionTypeEn(Object mdmsData, String institutionTypeId) {
        ...
        return JsonPath.read(mdmsData, DeathConstants.CR_MDMS_INST_TYPE_JSONPATH+"["+index+"].name");
    }

    public String getInstitutionTypeMl(Object mdmsData, String institutionTypeId) {
        List<String> tenants  = getInstitutionTypeCode(mdmsData);
        int index = tenants.indexOf(institutionTypeId);
        return JsonPath.read(mdmsData, DeathConstants.CR_MDMS_INST_TYPE_JSONPATH+"["+index+"].namelocal");
    }

    public String getInstitutionAddressEn(Object mdmsData, String institutionId) {
        List<String> tenants  = getInstitutionCode(mdmsData);
        int index = tenants.indexOf(institutionId);
        return JsonPath.read(mdmsData, DeathConstants.CR_MDMS_INSTITUTIONS_CODES_JSONPATH+"["+index+"].mainPlace");
    }

    public String getInstitutionAddressMl(Object mdmsData, String institutionId) {
        List<String> tenants  = getInstitutionCode(mdmsData);
        int index = tenants.indexOf(institutionId);
        return JsonPath.read(mdmsData, DeathConstants.CR_MDMS_INSTITUTIONS_CODES_JSONPATH+"["+index+"].mainPlaceLocal");
    }
