...
/**
     ...
     */
@Component
public class DeathRegistryMdmsUtil {

    private ServiceRequestRepository serviceRequestRepository;
    private CrDeathRegistryConfiguration config;

    @Autowired
    public DeathRegistryMdmsUtil(CrDeathRegistryConfiguration config, ServiceRequestRepository serviceRequestRepository) {
        this.config = config;
    ...
    private ModuleDetail getTenantIdRequest(String tenantId) {
        ...
        crDeathMasterDetails
                .add(MasterDetail.builder().name(DeathRegistryConstants.TENANTS).filter(filterCode).build());
    ...
    private List<ModuleDetail> getGenderTypeRequest() {
        ...
        crDeathMasterDetails
                .add(MasterDetail.builder().name(DeathRegistryConstants.GENDERTYPE).filter(filterCode).build());

        final String filterCodePlaceMaster = "$.[?(@.active==true)].code";
                crDeathMasterDetails
                           .add(MasterDetail.builder().name(DeathRegistryConstants.DEATH_PLACE_LIST).filter(filterCodePlaceMaster).build());
       

        ModuleDetail crDeathModuleDtls = ModuleDetail.builder().masterDetails(crDeathMasterDetails)
                .moduleName(DeathRegistryConstants.COMMON_MASTER_MODULE_NAME).build();
    ...
    private List<ModuleDetail> getBNDListRequest() {
        ...
        final String filterCodeDeathCauseMain = "$.[?(@.active==true)].code";
         crDeathMasterDetails
                    .add(MasterDetail.builder().name(DeathRegistryConstants.DEATH_CAUSE_MAIN).filter(filterCodeDeathCauseMain).build());
                    
        final String filterCodeDeathCauseSub = "$.[?(@.active==true)].code";
                    crDeathMasterDetails
                               .add(MasterDetail.builder().name(DeathRegistryConstants.DEATH_CAUSE_SUB).filter(filterCodeDeathCauseSub).build());
        ...
        final String filterCodeAgeUnit = "$.[?(@.active==true)].code";
                                          crDeathMasterDetails
                                                     .add(MasterDetail.builder().name(DeathRegistryConstants.AGE_UNIT).filter(filterCodeAgeUnit).build());

        final String filterCodeMedicalAttention = "$.[?(@.active==true)].code";
                                           crDeathMasterDetails
                                                     .add(MasterDetail.builder().name(DeathRegistryConstants.MEDICAL_ATTENTION_TYPE).filter(filterCodeMedicalAttention).build());
        ...
        ModuleDetail crDeathModuleDtls = ModuleDetail.builder().masterDetails(crDeathMasterDetails)
                .moduleName(DeathRegistryConstants.BND_MODULE_NAME).build();
    ...
    private List<ModuleDetail> getcommonMasterRequestP( String tenantId
        ...
        crDeathMasterDetails
                .add(MasterDetail.builder().name(DeathRegistryConstants.DISTRICT).filter(perAddrfilterCode).build());  
        
        final String perAddrfilterCodeState = "$.[?(@.code=='"+permanentAddressState+"')].name"; 
        crDeathMasterDetails
                .add(MasterDetail.builder().name(DeathRegistryConstants.STATE).filter(perAddrfilterCodeState).build());        
                
        final String perAddrfilterCodeCountry = "$.[?(@.code=='"+permanentAddressCountry+"')].name"; 
        crDeathMasterDetails
                .add(MasterDetail.builder().name(DeathRegistryConstants.COUNTRY).filter(perAddrfilterCodeCountry).build()); 
   ...
   private MdmsCriteriaReq getMDMSRequestCertificateHome(RequestInfo requestInfo    
    ...
    private MdmsCriteriaReq getMDMSRequestCertificateHomeMl(RequestInfo requestInfo    
      ...
      private ModuleDetail  getcommonMasterRequestHospial( String tenantId, String deathPlace ) {
        ...
        ModuleDetail crDeathModuleDtls = ModuleDetail.builder().masterDetails(crDeathMasterDetails)
                .moduleName(DeathRegistryConstants.TENANT_EGOV_LOCATION).build();
    ...
    private MdmsCriteriaReq getMDMSRequestCertificateOther(RequestInfo requestInfo   
        ...
        private ModuleDetail getdeathPlaceType(String deathPlaceType) {
                ...
                crDeathMasterDetails
                        .add(MasterDetail.builder().name(DeathRegistryConstants.OTHER_PLACE_TYPE).filter(filterCode).build());       
    ...
    private ModuleDetail  getcommonMasterDistrictEN(String lbDistrictMaster) {
       ...
       crDeathMasterDetails
       .add(MasterDetail.builder().name(DeathRegistryConstants.DISTRICT).filter(districtfilterCode).build());       
...
public Object mDMSCallCertificateLBDistrictMl(RequestInfo requestInfo
    ...
    private ModuleDetail  getcommonMasterTalukEN(String lbTalukMaster) {
       ...
       crDeathMasterDetails
       .add(MasterDetail.builder().name(DeathRegistryConstants.TALUK).filter(districtfilterCode).build());       
