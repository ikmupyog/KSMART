ALTER TABLE eg_tl_tradelicensedetail_audit DROP COLUMN licenseunittype, DROP COLUMN licenseunitid,
DROP COLUMN structureplacesubtype, DROP COLUMN customdetailtype,
DROP COLUMN businessactivitydesc, DROP COLUMN licenseetype, DROP COLUMN institutionid;
