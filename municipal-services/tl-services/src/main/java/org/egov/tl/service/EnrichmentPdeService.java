...
@Service
public class EnrichmentPdeService {
     ...
     */
    public void enrichTLCriteriaWithOwnerids(TradeLicenseSearchCriteria criteria,
    ...
    public void enrichOwner(UserDetailResponse userDetailResponse, List<TradeLicense> licenses) {
        ...
        licenses.forEach(license -> {
             ...
             * license.getCitizenInfo().addCitizenDetail(userIdToOwnerMap.get(license.
             * getCitizenInfo().getUuid()));
             * else
             * throw new CustomException("CITIZENINFO ERROR"
             * ,"The citizenInfo of trade License with ApplicationNumber: "+license.
             * getApplicationNumber()+" cannot be found");
             */
        });
    }
     ...
     */
    public List<TradeLicense> enrichTradeLicenseSearch(List<TradeLicense> licenses, TradeLicenseSearchCriteria criteria,
