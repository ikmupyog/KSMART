...
@Builder
@EqualsAndHashCode
public class EstablishmentUnit {
    ...
    @Size(max = 256)
    @SafeHtml
    @JsonProperty("establishmentUnitName")
    private String establishmentUnitName = null;

    @Size(max = 500)
    @SafeHtml
    @JsonProperty("establishmentUnitNameLocal")
    private String establishmentUnitNameLocal = null;
