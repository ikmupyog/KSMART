...
public class TLConstants {
        ...
        public static final List<String> NOTIFICATION_CODES = Collections.unmodifiableList(Arrays.asList(
                        NOTIFICATION_INITIATED_EMAIL, RENEWAL_NOTIFICATION_INITIATED,
                        RENEWAL_NOTIFICATION_INITIATED_EMAIL,
                        RENEWAL_NOTIFICATION_APPLIED, RENEWAL_NOTIFICATION_FIELD_INSPECTION,
                        RENEWAL_NOTIFICATION_PENDINGAPPROVAL,
                        RENEWAL_NOTIFICATION_REJECTED, RENEWAL_NOTIFICATION_APPROVED, NOTIFICATION_INITIATED,
                        NOTIFICATION_APPLIED,
                        NOTIFICATION_FIELD_INSPECTION,
                        NOTIFICATION_PAYMENT_OWNER, NOTIFICATION_RENEWAL_PAYMENT_OWNER, NOTIFICATION_PAYMENT_PAYER,
                        NOTIFICATION_RENEWAL_PAYMENT_PAYER,
                        NOTIFICATION_PAID, NOTIFICATION_APPROVED, NOTIFICATION_REJECTED, NOTIFICATION_CANCELLED,
                        NOTIFICATION_FIELD_CHANGED, NOTIFICATION_OBJECT_ADDED,
                        NOTIFICATION_OBJECT_REMOVED, NOTIFICATION_OBJECT_MODIFIED, NOTIFICATION_OBJECT_RENEW_MODIFIED,
                        NOTIFICATION_SENDBACK_CITIZEN,
                        NOTIFICATION_FORWARD_CITIZEN, NOTIFICATION_TL_REMINDER, NOTIFICATION_TL_REMINDER_EMAIL,
                        NOTIFICATION_FORWARD_CITIZEN_EMAIL, NOTIFICATION_SENDBACK_CITIZEN_EMAIL,
                        NOTIFICATION_OBJECT_RENEW_MODIFIED_EMAIL, NOTIFICATION_OBJECT_MODIFIED_EMAIL,
                        NOTIFICATION_OBJECT_REMOVED_EMAIL, NOTIFICATION_OBJECT_ADDED_EMAIL,
                        NOTIFICATION_FIELD_CHANGED_EMAIL,
                        NOTIFICATION_CANCELLED_EMAIL, NOTIFICATION_REJECTED_EMAIL, NOTIFICATION_APPROVED_EMAIL,
                        NOTIFICATION_PAID_EMAIL, NOTIFICATION_RENEWAL_PAYMENT_PAYER_EMAIL,
                        NOTIFICATION_RENEWAL_PAYMENT_OWNER_EMAIL, NOTIFICATION_PAYMENT_PAYER_EMAIL,
                        NOTIFICATION_PAYMENT_OWNER_EMAIL, NOTIFICATION_FIELD_INSPECTION_EMAIL,
                        NOTIFICATION_APPLIED_EMAIL, RENEWAL_NOTIFICATION_APPROVED_EMAIL,
                        RENEWAL_NOTIFICATION_APPLIED_EMAIL,
                        RENEWAL_NOTIFICATION_FIELD_INSPECTION_EMAIL,
                        RENEWAL_NOTIFICATION_PENDINGAPPROVAL_EMAIL, RENEWAL_NOTIFICATION_REJECTED_EMAIL,
                        NOTIFICATION_PENDING_APPROVAL, NOTIFICATION_PENDING_APPROVAL_EMAIL,
                        NOTIFICATION_EXPIRED, NOTIFICATION_EXPIRED_EMAIL, NOTIFICATION_MANUAL_EXPIRED,
                        NOTIFICATION_MANUAL_EXPIRED_EMAIL));
        ...
        public static final List<String> FIELDS_TO_IGNORE = Collections
                        .unmodifiableList(Arrays.asList(VARIABLE_ACTION, VARIABLE_WFDOCUMENTS,
                                        VARIABLE_CREATEDBY, VARIABLE_LASTMODIFIEDBY, VARIABLE_CREATEDTIME,
                                        VARIABLE_LASTMODIFIEDTIME,
                                        VARIABLE_STATUS, VARIABLE_LASTMODIFIEDDATE, VARIABLE_ISSUED_DATE,
                                        VARIABLE_COMMENT));
