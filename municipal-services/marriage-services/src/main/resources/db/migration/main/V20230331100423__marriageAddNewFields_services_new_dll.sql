...
ALTER TABLE public.eg_register_marriage_witness_details_audit
   ADD COLUMN IF NOT EXISTS tenantid character varying(64) COLLATE pg_catalog."default",
  ALTER COLUMN aadharno TYPE character varying(200) COLLATE pg_catalog."default";

ALTER TABLE public.eg_register_marriage_document
    ADD COLUMN IF NOT EXISTS applicationNumber character varying(64) COLLATE pg_catalog."default";

ALTER TABLE public.eg_register_marriage_document_audit
    ADD COLUMN IF NOT EXISTS applicationNumber character varying(64) COLLATE pg_catalog."default";
...
ALTER TABLE public.eg_marriage_details_audit
      RENAME COLUMN grromAgeCorreflag TO groomAgeCorreflag;
ALTER TABLE public.eg_marriage_details
      RENAME COLUMN grromAgeCorreflag TO groomAgeCorreflag;


ALTER TABLE public.eg_marriage_details
      ADD COLUMN IF NOT EXISTS brideUrl character varying(200) COLLATE pg_catalog."default",
      ADD COLUMN IF NOT EXISTS groomUrl character varying(200) COLLATE pg_catalog."default",
      ADD COLUMN IF NOT EXISTS imageUuid character varying(64) COLLATE pg_catalog."default";
