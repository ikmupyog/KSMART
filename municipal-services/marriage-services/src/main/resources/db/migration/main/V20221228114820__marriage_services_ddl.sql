...
(
        ...
        districtid character varying(64) COLLATE pg_catalog."default" DEFAULT 'null'::character varying,
        lbtype character varying(64) COLLATE pg_catalog."default" DEFAULT 'null'::character varying,
        tenantid character varying(64) COLLATE pg_catalog."default" DEFAULT 'null'::character varying,
        placetype character varying(64) COLLATE pg_catalog."default" DEFAULT 'null'::character varying,
        placeothers character varying(64) COLLATE pg_catalog."default" DEFAULT 'null'::character varying,
        placeid character varying(1000) COLLATE pg_catalog."default" DEFAULT 'null'::character varying,
        placename_en character varying(1000) COLLATE pg_catalog."default" DEFAULT 'null'::character varying,
        street_name_en character varying(1000) COLLATE pg_catalog."default" DEFAULT 'null'::character varying,
        street_name_ml character varying(1000) COLLATE pg_catalog."default" DEFAULT 'null'::character varying,
        placename_mal character varying(1000) COLLATE pg_catalog."default" DEFAULT 'null'::character varying,
        ward_code character varying(64) COLLATE pg_catalog."default" DEFAULT 'null'::character varying,
        talukid character varying(64) COLLATE pg_catalog."default" DEFAULT 'null'::character varying,
        village_name character varying(64) COLLATE pg_catalog."default" DEFAULT 'null'::character varying,
        marriage_type character varying(64) COLLATE pg_catalog."default" DEFAULT 'null'::character varying,
        oth_marriage_type character varying(200) COLLATE pg_catalog."default" DEFAULT 'null'::character varying,
        landmark character varying(1000) COLLATE pg_catalog."default" DEFAULT 'null'::character varying,
        locality_en character varying(1000) COLLATE pg_catalog."default" DEFAULT 'null'::character varying,
        locality_ml character varying(1000) COLLATE pg_catalog."default" DEFAULT 'null'::character varying,
        othersspecify character varying(1000) COLLATE pg_catalog."default" DEFAULT 'null'::character varying,
        ...
        fileno character varying(64) COLLATE pg_catalog."default" DEFAULT 'null'::character varying,
        file_date bigint,
        file_status character varying(64) COLLATE pg_catalog."default" DEFAULT 'null'::character varying,
        applicationnumber character varying(64) COLLATE pg_catalog."default" DEFAULT 'null'::character varying,
        registrationno character varying(64) COLLATE pg_catalog."default" DEFAULT 'null'::character varying,
        registration_date bigint,
        action character varying(64) COLLATE pg_catalog."default" DEFAULT 'null'::character varying,
        status character varying(64) COLLATE pg_catalog."default" DEFAULT 'null'::character varying,
    createdtime bigint,
