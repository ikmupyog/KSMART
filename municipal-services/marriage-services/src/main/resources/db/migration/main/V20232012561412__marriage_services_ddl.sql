...
(
    ...
    houseno_and_nameen character varying(2500) COLLATE pg_catalog."default",
    houseno_and_nameml character varying(2500) COLLATE pg_catalog."default",
    religious_institution character varying(1000) COLLATE pg_catalog."default",
    public_or_privateplace character varying(1000) COLLATE pg_catalog."default",
    public_or_privateplacennameplace_en character varying(2500) COLLATE pg_catalog."default",
    public_or_privateplacennameplace_ml character varying(2500) COLLATE pg_catalog."default",
    religious_institution_other character varying(1000) COLLATE pg_catalog."default",
    religious_institution_othername_en character varying(2500) COLLATE pg_catalog."default",
    religious_institution_othername_ml character varying(2500) COLLATE pg_catalog."default",
    CONSTRAINT eg_register_marriage_place_details_pkey PRIMARY KEY (id),
    CONSTRAINT eg_register_marriage_place_details_applicationnumber_fkey UNIQUE (applicationnumber),
    CONSTRAINT eg_register_marriage_place_details_fm_fileno_fkey UNIQUE (fileno, tenantid),
    CONSTRAINT eg_register_marriage_place_details_registrationno_fkey UNIQUE (registrationno, tenantid)
)
...
CREATE TABLE IF NOT EXISTS public.eg_register_marriage_bride_details
(
    id character varying(64) COLLATE pg_catalog."default" NOT NULL,
...
-- Table: public.eg_register_marriage_groom_details

-- DROP TABLE IF EXISTS public.eg_register_marriage_groom_details;

CREATE TABLE IF NOT EXISTS public.eg_register_marriage_groom_details
(
    id character varying(64) COLLATE pg_catalog."default" NOT NULL,
    residentship character varying(64) COLLATE pg_catalog."default",
    adharno character varying(15) COLLATE pg_catalog."default",
    ...
    lastmodifiedtime bigint,
    lastmodifiedby character varying(64) COLLATE pg_catalog."default",
    CONSTRAINT eg_register_marriage_groom_details_pkey PRIMARY KEY (id),
    CONSTRAINT eg_register_marriage_groom_details_fkey FOREIGN KEY (marriageid)
        REFERENCES public.eg_register_marriage_details (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
)
...
ALTER TABLE IF EXISTS public.eg_register_marriage_groom_details
    OWNER to postgres;
...
(
    ...
    lastmodifiedtime bigint,
    lastmodifiedby character varying(64) COLLATE pg_catalog."default",
    w2_adharno character varying(15) COLLATE pg_catalog."default",
    w2_name_en character varying(200) COLLATE pg_catalog."default",
    w2_name_mal character varying(200) COLLATE pg_catalog."default",
    w2_age integer,
    w2_address_en character varying(200) COLLATE pg_catalog."default",
    w2_address_mal character varying(200) COLLATE pg_catalog."default",
    w2_mobile character varying(150) COLLATE pg_catalog."default",
    w2_is_message_received boolean,
    w2_is_esigned boolean,
