...
(
    ...
    father_aadharno character varying(15) COLLATE pg_catalog."default",
    mother_aadharno character varying(15) COLLATE pg_catalog."default",
    ...
    guardian_aadharno character varying(15) COLLATE pg_catalog."default",
