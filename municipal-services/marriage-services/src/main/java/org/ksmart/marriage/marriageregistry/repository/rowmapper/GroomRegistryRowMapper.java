...
import org.ksmart.marriage.marriageregistry.model.GroomRegistryDetails;
    ...
    default GroomRegistryDetails getGroomDetails (ResultSet rs) throws SQLException{
        ...
        return GroomRegistryDetails.builder()
             //  .groomId(rs.getString("GD_id"))
               ...
               .adharno(rs.getString("GD_aadharno"))
               ...
               .father_adharno(rs.getString("GD_father_aadharno"))
               .mother_adharno(rs.getString("GD_mother_aadharno"))
               .guardianname_en(rs.getString("GD_guardianname_en"))
               .guardianname_ml(rs.getString("GD_guardianname_ml"))
               .guardian_adhar(rs.getString("GD_guardian_aadharno"))
             ...
             //  .is_spouse_living(Boolean.valueOf(rs.getString("GD_is_spouse_living")))
               .no_of_spouse_living(Integer.valueOf(rs.getString("GD_livingspouseNo")))
