...
public class CorrectionApplicationToRegistryMapper {
    ...
    public MarriageRegistryRequest convert(List<MarriageRegistryDetails> registryDetails, List<MarriageApplicationDetails> aplnDetails) {
        ...
        if (registryDetails.get(0) != null && aplnDetails.get(0) != null) {
            ...
            registryDetails.get(0).getBrideAddressDetails().setPermntOutsideIndiaLineoneEn(aplnDetails.get(0).getBrideAddressDetails().getPermntOutsideIndiaLineoneEn());
            registryDetails.get(0).getBrideAddressDetails().setPermntOutsideIndiaLineoneMl(aplnDetails.get(0).getBrideAddressDetails().getPermntOutsideIndiaLineoneMl());
            registryDetails.get(0).getBrideAddressDetails().setPermntOutsideIndiaLinetwoEn(aplnDetails.get(0).getBrideAddressDetails().getPermntOutsideIndiaLinetwoEn());
            registryDetails.get(0).getBrideAddressDetails().setPermntOutsideIndiaLinetwoMl(aplnDetails.get(0).getBrideAddressDetails().getPermntOutsideIndiaLinetwoMl());
            ...
            registryDetails.get(0).getGroomAddressDetails().setPermntOutsideIndiaLineoneEn(aplnDetails.get(0).getGroomAddressDetails().getPermntOutsideIndiaLineoneEn());
            registryDetails.get(0).getGroomAddressDetails().setPermntOutsideIndiaLineoneMl(aplnDetails.get(0).getGroomAddressDetails().getPermntOutsideIndiaLineoneMl());
            registryDetails.get(0).getGroomAddressDetails().setPermntOutsideIndiaLinetwoEn(aplnDetails.get(0).getGroomAddressDetails().getPermntOutsideIndiaLinetwoEn());
            registryDetails.get(0).getGroomAddressDetails().setPermntOutsideIndiaLinetwoMl(aplnDetails.get(0).getGroomAddressDetails().getPermntOutsideIndiaLinetwoMl());
