...
//    CommonQueryBuilder commonQueryBuilder;
    ...
    private static final String QUERY = new StringBuilder()
            ...
            .append("LEFT JOIN eg_marriage_permanent_address_details as BPMA ON BPMA.marriageid = MD.id AND ")
            .append("BPMA.bride_groom ='B' ")
            .append("LEFT JOIN eg_marriage_permanent_address_details as GPMA ON GPMA.marriageid = MD.id AND ")
