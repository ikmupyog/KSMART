...
public class ApplicantServiceQueryBuilder extends BaseQueryBuilder {
    ...
    private static final String QUERY = new StringBuilder().append(" SELECT")
                                                           ...
                                                           .append("    , sd.createdby AS servicedocument_createdby, sd.createdtime AS servicedocument_createdtime")
                                                           .append("    , sd.lastmodifiedby AS servicedocument_lastmodifiedby, sd.lastmodifiedtime AS servicedocument_lastmodifiedtime")
                                                           ...
                                                           .append("    , apc.createdtime AS applicantdetail_createdtime, apc.lastmodifiedby AS applicantdetail_lastmodifiedby")
                                                           .append("    , apc.lastmodifiedtime AS applicantdetail_lastmodifiedtime")
