...
@Builder
@ToString
public class DraftFilesProcessInstanceRequest {
    ...
    public DraftFilesProcessInstanceRequest addProcessInstanceItem(DraftFilesProcessInstance processInstanceItem) {
