...
public class DraftCertificateService {
    ...
    DraftCertificateService(final DraftFilesRepository repository, final DraftCertificateEnrichment draftCertificateEnrichment,
...
// Circular
        if(draftDetails.getDraftType().equals("1")){
...
// Affidavit
        if(draftDetails.getDraftType().equals("2")){
...
// Notice
        if(draftDetails.getDraftType().equals("3")){
...
// Memo
        if(draftDetails.getDraftType().equals("4")){
...
// Certificate
        if(draftDetails.getDraftType().equals("5")){
        ...
        final String draftCertificatePath = urlCreateEndPoint
    ...
    private BuildDraftCertificateRequest buildDraftCertificateRequest(final DraftFiles draftDetails,
     ...
     private BuildDraftCertificate buildDraftCertificateDetails(final DraftFiles draftDetails,
                                                                        final String fileCode,
                                                                      final String embeddedUrl) {
