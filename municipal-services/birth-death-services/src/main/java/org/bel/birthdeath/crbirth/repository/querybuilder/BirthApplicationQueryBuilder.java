package org.bel.birthdeath.crbirth.repository.querybuilder;
...
public class BirthApplicationQueryBuilder extends BaseBirthQuery {
    private static final String QUERY = new StringBuilder().append("SELECT ebd.id,	ebd.dateofreport,	ebd.dateofbirth,	ebd.timeofbirth,	ebd.am_pm,	ebd.firstname_en,	ebd.firstname_ml,	ebd.middlename_en,")
