-- Table: public.tr_live_samaswasam3

-- DROP TABLE IF EXISTS public.tr_live_samaswasam3;

CREATE TABLE IF NOT EXISTS public.tr_live_samaswasam3
(
    ...
    applicant_heamo_center_eng character varying(50) COLLATE pg_catalog."default",
    applicant_heamo_center_mal character varying(50) COLLATE pg_catalog."default",
    applicant_heamo_doctor_eng character varying(50) COLLATE pg_catalog."default",
    applicant_heamo_doctor_mal character varying(50) COLLATE pg_catalog."default",
    ...
    CONSTRAINT tr_live_samaswasam3_pkey PRIMARY KEY (intid, numkssmpensionerid)
)